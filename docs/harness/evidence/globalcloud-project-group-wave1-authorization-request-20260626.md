...
owner: KDS
kds_space: 开发
kds_path: 开发/05-KDS/docs/harness/evidence/globalcloud-project-group-wave1-authorization-request-20260626.md
...
| `AUTH-WAVE1-GPCF-POST-SCHEME-REVIEW-20260626` | `WAVE1-GPCF-POST-SCHEME-REVIEW-001` | 允许逐仓审查 17 仓 scheme recognition dirty 变更 | `allow_wave1_gpcf_post_scheme_review` | 仅限 review 和 evidence 记录，不自动 stage/commit/push/delete | stage、commit、push、delete、cleanup、真实 KDS API 同步、accepted/integrated | `review_allowed=false` |
...
| `allow_wave1_gpcf_post_scheme_review=true` | 可逐仓 review 方案识别变更 | 不允许 stage、commit、push、delete 或 cleanup |
...
| `pre_execution_gate` | 必须复跑 Wave 1 环境就绪、对应 pack validator 和 Loop 文档门禁 |
