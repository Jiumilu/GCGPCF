...
| 5 | `GFIS-OWNER-RECEIPT-TASK-005` | `runtime_primary_key` | GFIS_runtime_owner_after_source_dispatch_waes_kds_receipts | `blocked_missing_upstream_receipts` | `GFIS runtime read-only primary key evidence after authorized intake` |
