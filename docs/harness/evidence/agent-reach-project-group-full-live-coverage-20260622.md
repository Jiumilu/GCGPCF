...
title: 项目群全量真实搜索覆盖证据 2026-06-22
project: GPCF
...
owner: GPCF
kds_space: 开发
kds_path: 开发/12-GPCF/docs/harness/evidence/agent-reach-project-group-full-live-coverage-20260622.md
...
- 本证据仅限候选态。
- 本证据不声明 accepted、integrated 或 production_ready。
- 原始提供方负载不做持久化保存。
