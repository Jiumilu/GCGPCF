...
本轮覆盖当前 109 个 WAS/Ontology 相关 Loop round，并兼容早期 `flat_v1` 与新增 `nested_v2` 两种 context 结构。新增覆盖包括 source-record monitor 001-083、candidate precheck execution 001-008、waiting-room、completion audit、status refresh、scenario profile matrix、WAES/KDS/RAG/writeback gate pack 和 project-group ontology registry。
