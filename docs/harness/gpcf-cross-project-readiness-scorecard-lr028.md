---
doc_id: GPCF-DOC-2A9E353FAE
title: 跨项目 readiness scorecard
project: KDS
...
owner: KDS
kds_space: 开发
kds_path: 开发/05-KDS/docs/harness/gpcf-cross-project-readiness-scorecard-lr028.md
source_path: docs/harness/gpcf-cross-project-readiness-scorecard-lr028.md
...
# 跨项目 readiness scorecard

## Round

| 字段 | 值 |
|---|---|
| Round ID | `GPCF-CF-LR-028` |
| 模式 | Loop L3 托管冲刺模式 |
| 本次 L3 计数 | 12/15 |
| 当前状态上限 | `partial` |
| 目标 | 把项目准备度转换为可比较 scorecard 与排序。 |
| 下一轮 | GPCF-CF-LR-029 |
...
| 输出项 | 路径或状态 |
|---|---|
| 本轮受控文档 | `docs/harness/gpcf-cross-project-readiness-scorecard-lr028.md` |
| Loop record | `docs/harness/loops/loop-round-GPCF-CF-LR-028.md` |
