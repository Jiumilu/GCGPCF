...
owner: KDS
kds_space: 开发
kds_path: 开发/05-KDS/docs/harness/gpcf-project-startup-template-hardening-lr029.md
source_path: docs/harness/gpcf-project-startup-template-hardening-lr029.md
...
| 字段 | 值 |
|---|---|
| Round ID | `GPCF-CF-LR-029` |
| 模式 | Loop L3 托管冲刺模式 |
| 本次 L3 计数 | 13/15 |
| 当前状态上限 | `partial` |
| 目标 | 固化 Manifest、loop-state、evidence-index、acceptance 四类模板。 |
| 下一轮 | GPCF-CF-LR-030 |
...
| 输出项 | 路径或状态 |
|---|---|
| 本轮受控文档 | `docs/harness/gpcf-project-startup-template-hardening-lr029.md` |
| Loop record | `docs/harness/loops/loop-round-GPCF-CF-LR-029.md` |
