---
doc_id: GPCF-DOC-B096D9C533
title: L3 session 重启与计数器台账
project: KDS
...
owner: KDS
kds_space: 开发
kds_path: 开发/05-KDS/docs/harness/gpcf-l3-session-reset-counter-register-lr003.md
source_path: docs/harness/gpcf-l3-session-reset-counter-register-lr003.md
...
| 字段 | 值 |
|---|---|
| Round ID | `GPCF-CF-LR-003` |
| 模式 | Loop L3 托管冲刺模式 |
| 本次 L3 计数 | 2/15 |
| 当前状态上限 | `partial` |
| 目标 | 建立新一轮 L3 的 session、计数器、停止类型和证据字段。 |
| 下一轮 | GPCF-CF-LR-004 |
...
| 输出项 | 路径或状态 |
|---|---|
| 本轮受控文档 | `docs/harness/gpcf-l3-session-reset-counter-register-lr003.md` |
| Loop record | `docs/harness/loops/loop-round-GPCF-CF-LR-003.md` |
