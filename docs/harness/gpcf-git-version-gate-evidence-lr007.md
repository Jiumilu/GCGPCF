---
doc_id: GPCF-DOC-C7FBCBC166
title: Git 版本门禁 evidence 包
project: KDS
...
owner: KDS
kds_space: 开发
kds_path: 开发/05-KDS/docs/harness/gpcf-git-version-gate-evidence-lr007.md
source_path: docs/harness/gpcf-git-version-gate-evidence-lr007.md
...
| 本次 L3 计数 | 6/15 |
| 当前状态上限 | `partial` |
| 目标 | 记录 dirty、diff-check、敏感文件和提交推送边界。 |
| 下一轮 | GPCF-CF-LR-008 |
...
| 输出项 | 路径或状态 |
|---|---|
| 本轮受控文档 | `docs/harness/gpcf-git-version-gate-evidence-lr007.md` |
| Loop record | `docs/harness/loops/loop-round-GPCF-CF-LR-007.md` |
