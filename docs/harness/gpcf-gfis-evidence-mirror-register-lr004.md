---
doc_id: GPCF-DOC-BFB5658141
title: GFIS evidence 镜像接收登记
project: KDS
...
owner: KDS
kds_space: 开发
kds_path: 开发/05-KDS/docs/harness/gpcf-gfis-evidence-mirror-register-lr004.md
source_path: docs/harness/gpcf-gfis-evidence-mirror-register-lr004.md
...
# GFIS evidence 镜像接收登记

## Round

| 字段 | 值 |
|---|---|
| Round ID | `GPCF-CF-LR-004` |
| 模式 | Loop L3 托管冲刺模式 |
| 本次 L3 计数 | 3/15 |
| 当前状态上限 | `partial` |
| 目标 | 登记 GFIS LR-060 后需要进入 GPCF 总控索引的证据边界。 |
| 下一轮 | GPCF-CF-LR-005 |
...
| 输出项 | 路径或状态 |
|---|---|
| 本轮受控文档 | `docs/harness/gpcf-gfis-evidence-mirror-register-lr004.md` |
| Loop record | `docs/harness/loops/loop-round-GPCF-CF-LR-004.md` |
