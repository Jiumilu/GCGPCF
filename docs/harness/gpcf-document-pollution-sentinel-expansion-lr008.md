...
owner: KDS
kds_space: 开发
kds_path: 开发/05-KDS/docs/harness/gpcf-document-pollution-sentinel-expansion-lr008.md
source_path: docs/harness/gpcf-document-pollution-sentinel-expansion-lr008.md
...
| 字段 | 值 |
|---|---|
| Round ID | `GPCF-CF-LR-008` |
| 模式 | Loop L3 托管冲刺模式 |
| 本次 L3 计数 | 7/15 |
| 当前状态上限 | `partial` |
| 目标 | 扩展 front matter、README、归档和镜像冲突的污染防线。 |
| 下一轮 | GPCF-CF-LR-009 |
...
| 输出项 | 路径或状态 |
|---|---|
| 本轮受控文档 | `docs/harness/gpcf-document-pollution-sentinel-expansion-lr008.md` |
| Loop record | `docs/harness/loops/loop-round-GPCF-CF-LR-008.md` |
