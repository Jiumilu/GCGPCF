...
owner: KDS
kds_space: 开发
kds_path: 开发/05-KDS/docs/harness/gpcf-xgd-project-startup-pack-lr020.md
source_path: docs/harness/gpcf-xgd-project-startup-pack-lr020.md
...
| 本次 L3 计数 | 4/15 |
| 当前状态上限 | `partial` |
| 目标 | 为 XGD 大象长程 Agent 主线形成 Manifest 与 loop-state 要求。 |
| 下一轮 | GPCF-CF-LR-021 |
...
| 输出项 | 路径或状态 |
|---|---|
| 本轮受控文档 | `docs/harness/gpcf-xgd-project-startup-pack-lr020.md` |
| Loop record | `docs/harness/loops/loop-round-GPCF-CF-LR-020.md` |
