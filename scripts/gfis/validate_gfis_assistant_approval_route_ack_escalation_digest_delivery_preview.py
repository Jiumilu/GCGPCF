...
POLICY = ROOT / "okf" / "gfis-assistant-approval-route-ack-escalation-digest-delivery-preview-policy.yaml"
TYPE_FILE = ROOT / "packages" / "shared" / "src" / "knowledge" / "gfis-assistant-approval-route-ack-escalation-digest-delivery-preview.ts"
...
def main() -> int:
    ...
    unions = {
        "GfisAssistantApprovalRouteAckEscalationDigestDeliveryPreviewType": policy["delivery_types"],
        "GfisAssistantApprovalRouteAckEscalationDigestDeliveryPreviewStatus": policy["delivery_statuses"],
        "GfisAssistantApprovalRouteAckEscalationDigestDeliveryPreviewDecision": policy["delivery_decisions"],
        "GfisAssistantApprovalRouteAckEscalationDigestDeliveryPreviewScope": policy["delivery_scopes"],
        "GfisAssistantApprovalRouteAckEscalationDigestDeliveryPreviewChannel": policy["delivery_channels"],
        "GfisAssistantApprovalRouteAckEscalationDigestDeliveryPreviewBlockedAction": policy["blocked_actions"],
    }
    ...
    if failures:
        print("gfis_assistant_approval_route_ack_escalation_digest_delivery_preview=fail")
        for failure in failures:
            print(failure)
        return 1

    print(
        "gfis_assistant_approval_route_ack_escalation_digest_delivery_preview=pass "
