#!/usr/bin/env python3
"""Validate GFIS Assistant DKS-180 acknowledgement escalation digest preview no-write boundary."""
...
POLICY = ROOT / "okf" / "gfis-assistant-dks-180-routing-queue-notification-acknowledgement-escalation-digest-preview-policy.yaml"
TYPE_FILE = ROOT / "packages" / "shared" / "src" / "knowledge" / "gfis-assistant-dks-180-routing-queue-notification-acknowledgement-escalation-digest-preview.ts"
FIXTURE = ROOT / "fixtures" / "gfis" / "gfis-assistant-dks-180-routing-queue-notification-acknowledgement-escalation-digest-preview-dry-run.json"
...
def main() -> int:
    ...
    unions = {
        "GfisAssistantDks180RoutingQueueNotificationAcknowledgementEscalationDigestPreviewType": policy["digest_types"],
        "GfisAssistantDks180RoutingQueueNotificationAcknowledgementEscalationDigestPreviewStatus": policy["digest_statuses"],
        "GfisAssistantDks180RoutingQueueNotificationAcknowledgementEscalationDigestPreviewDecision": policy["digest_decisions"],
        "GfisAssistantDks180RoutingQueueNotificationAcknowledgementEscalationDigestPreviewScope": policy["digest_scopes"],
        "GfisAssistantDks180RoutingQueueNotificationAcknowledgementEscalationDigestPreviewChannel": policy["digest_channels"],
        "GfisAssistantDks180RoutingQueueNotificationAcknowledgementEscalationDigestPreviewPriority": policy["digest_priorities"],
        "GfisAssistantDks180RoutingQueueNotificationAcknowledgementEscalationDigestPreviewReason": policy["digest_reasons"],
        "GfisAssistantDks180RoutingQueueNotificationAcknowledgementEscalationDigestPreviewBlockedAction": policy["blocked_actions"],
    }
    ...
    if failures:
        print("gfis_assistant_dks_180_routing_queue_notification_acknowledgement_escalation_digest_preview=fail")
        for failure in failures:
            print(failure)
        return 1

    print(
        "gfis_assistant_dks_180_routing_queue_notification_acknowledgement_escalation_digest_preview=pass "
