#!/usr/bin/env python3
"""Validate GFIS Assistant DKS-206 acknowledgement escalation digest delivery acknowledgement preview no-write boundary."""
...
POLICY = ROOT / "okf" / "gfis-assistant-dks-206-routing-queue-notification-acknowledgement-escalation-digest-delivery-ack-escalation-sla-breach-review-resolution-option-approval-packet-routing-queue-notification-acknowledgement-escalation-digest-delivery-ack-preview-policy.yaml"
TYPE_FILE = ROOT / "packages" / "shared" / "src" / "knowledge" / "gfis-assistant-dks-206-routing-queue-notification-acknowledgement-escalation-digest-delivery-ack-escalation-sla-breach-review-resolution-option-approval-packet-routing-queue-notification-acknowledgement-escalation-digest-delivery-ack-preview.ts"
FIXTURE = ROOT / "fixtures" / "gfis" / "gfis-assistant-dks-206-routing-queue-notification-acknowledgement-escalation-digest-delivery-ack-escalation-sla-breach-review-resolution-option-approval-packet-routing-queue-notification-acknowledgement-escalation-digest-delivery-ack-preview-dry-run.json"
...
def main() -> int:
    ...
    unions = {
        "GfisAssistantDks206RoutingQueueNotificationAcknowledgementEscalationDigestDeliveryAckEscalationSlaBreachReviewResolutionOptionApprovalPacketRoutingQueueNotificationAcknowledgementEscalationDigestDeliveryAckPreviewType": policy["acknowledgement_types"],
        "GfisAssistantDks206RoutingQueueNotificationAcknowledgementEscalationDigestDeliveryAckEscalationSlaBreachReviewResolutionOptionApprovalPacketRoutingQueueNotificationAcknowledgementEscalationDigestDeliveryAckPreviewStatus": policy["acknowledgement_statuses"],
        "GfisAssistantDks206RoutingQueueNotificationAcknowledgementEscalationDigestDeliveryAckEscalationSlaBreachReviewResolutionOptionApprovalPacketRoutingQueueNotificationAcknowledgementEscalationDigestDeliveryAckPreviewDecision": policy["acknowledgement_decisions"],
        "GfisAssistantDks206RoutingQueueNotificationAcknowledgementEscalationDigestDeliveryAckEscalationSlaBreachReviewResolutionOptionApprovalPacketRoutingQueueNotificationAcknowledgementEscalationDigestDeliveryAckPreviewScope": policy["acknowledgement_scopes"],
        "GfisAssistantDks206RoutingQueueNotificationAcknowledgementEscalationDigestDeliveryAckEscalationSlaBreachReviewResolutionOptionApprovalPacketRoutingQueueNotificationAcknowledgementEscalationDigestDeliveryAckPreviewMethod": policy["acknowledgement_methods"],
        "GfisAssistantDks206RoutingQueueNotificationAcknowledgementEscalationDigestDeliveryAckEscalationSlaBreachReviewResolutionOptionApprovalPacketRoutingQueueNotificationAcknowledgementEscalationDigestDeliveryAckPreviewPriority": policy["acknowledgement_priorities"],
        "GfisAssistantDks206RoutingQueueNotificationAcknowledgementEscalationDigestDeliveryAckEscalationSlaBreachReviewResolutionOptionApprovalPacketRoutingQueueNotificationAcknowledgementEscalationDigestDeliveryAckPreviewReason": policy["acknowledgement_reasons"],
        "GfisAssistantDks206RoutingQueueNotificationAcknowledgementEscalationDigestDeliveryAckEscalationSlaBreachReviewResolutionOptionApprovalPacketRoutingQueueNotificationAcknowledgementEscalationDigestDeliveryAckPreviewBlockedAction": policy["blocked_actions"],
    }
    ...
    acknowledgement_priorities = set(policy["acknowledgement_priorities"])
    ...
    for preview in previews:
        ...
        if preview["acknowledgementPriority"] not in acknowledgement_priorities:
            failures.append(f"{preview_id}: acknowledgementPriority must be declared")
        if not preview["requiredEvidenceRefs"] or not preview["acknowledgementReasonRefs"]:
            failures.append(f"{preview_id}: requiredEvidenceRefs and acknowledgementReasonRefs are required")
    ...
    if failures:
        print("gfis_assistant_dks_206_routing_queue_notification_acknowledgement_escalation_digest_delivery_ack_preview=fail")
        for failure in failures:
            print(failure)
        return 1

    print(
        "gfis_assistant_dks_206_routing_queue_notification_acknowledgement_escalation_digest_delivery_ack_preview=pass "
        ...
        f"total_methods={actual['totalMethodCount']} total_required_evidence={actual['totalRequiredEvidenceCount']} "
        f"total_acknowledgement_reasons={actual['totalAcknowledgementReasonCount']} total_blocked_acknowledgement={actual['totalBlockedAcknowledgementCount']} "
