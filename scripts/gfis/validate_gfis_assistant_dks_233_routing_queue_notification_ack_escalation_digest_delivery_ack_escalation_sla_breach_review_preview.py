#!/usr/bin/env python3
"""Validate GFIS Assistant DKS-233 SLA breach review preview no-write boundary."""
...
POLICY = ROOT / "okf" / "gfis-assistant-dks-233-routing-queue-notification-ack-escalation-digest-delivery-ack-escalation-sla-breach-review-preview-policy.yaml"
TYPE_FILE = ROOT / "packages" / "shared" / "src" / "knowledge" / "gfis-assistant-dks-233-routing-queue-notification-ack-escalation-digest-delivery-ack-escalation-sla-breach-review-preview.ts"
FIXTURE = ROOT / "fixtures" / "gfis" / "gfis-assistant-dks-233-routing-queue-notification-ack-escalation-digest-delivery-ack-escalation-sla-breach-review-preview-dry-run.json"
...
def main() -> int:
    ...
    unions = {
        "GfisAssistantDks233RoutingQueueNotificationAckEscalationDigestDeliveryAckEscalationSlaBreachReviewPreviewType": policy["breach_review_types"],
        "GfisAssistantDks233RoutingQueueNotificationAckEscalationDigestDeliveryAckEscalationSlaBreachReviewPreviewStatus": policy["breach_review_statuses"],
        "GfisAssistantDks233RoutingQueueNotificationAckEscalationDigestDeliveryAckEscalationSlaBreachReviewPreviewDecision": policy["breach_review_decisions"],
        "GfisAssistantDks233RoutingQueueNotificationAckEscalationDigestDeliveryAckEscalationSlaBreachReviewPreviewScope": policy["breach_review_scopes"],
        "GfisAssistantDks233RoutingQueueNotificationAckEscalationDigestDeliveryAckEscalationSlaBreachReviewPreviewSeverity": policy["breach_severities"],
        "GfisAssistantDks233RoutingQueueNotificationAckEscalationDigestDeliveryAckEscalationSlaBreachReviewPreviewReason": policy["breach_reasons"],
        "GfisAssistantDks233RoutingQueueNotificationAckEscalationDigestDeliveryAckEscalationSlaBreachReviewPreviewBlockedAction": policy["blocked_actions"],
    }
    ...
    if failures:
        print("gfis_assistant_dks_233_routing_queue_notification_ack_escalation_digest_delivery_ack_escalation_sla_breach_review_preview=fail")
        for failure in failures:
            print(failure)
        return 1

    print(
        "gfis_assistant_dks_233_routing_queue_notification_ack_escalation_digest_delivery_ack_escalation_sla_breach_review_preview=pass "
