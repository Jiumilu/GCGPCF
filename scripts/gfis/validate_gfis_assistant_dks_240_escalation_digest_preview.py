#!/usr/bin/env python3
"""Validate GFIS Assistant DKS-240 escalation digest preview no-write boundary."""
...
SLUG = "gfis-assistant-dks-240-escalation-digest-preview"
...
TYPE_PREFIX = "GfisAssistantDks240EscalationDigestPreview"
