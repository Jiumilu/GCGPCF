#!/usr/bin/env python3
"""Validate GFIS Assistant DKS-232 delivery acknowledgement escalation SLA preview no-write boundary."""
...
POLICY = ROOT / "okf" / "gfis-assistant-dks-232-routing-queue-notification-ack-escalation-digest-delivery-ack-escalation-sla-breach-review-resolution-option-approval-packet-routing-queue-notification-ack-escalation-digest-delivery-ack-escalation-sla-preview-policy.yaml"
TYPE_FILE = ROOT / "packages" / "shared" / "src" / "knowledge" / "gfis-assistant-dks-232-routing-queue-notification-ack-escalation-digest-delivery-ack-escalation-sla-breach-review-resolution-option-approval-packet-routing-queue-notification-ack-escalation-digest-delivery-ack-escalation-sla-preview.ts"
FIXTURE = ROOT / "fixtures" / "gfis" / "gfis-assistant-dks-232-routing-queue-notification-ack-escalation-digest-delivery-ack-escalation-sla-breach-review-resolution-option-approval-packet-routing-queue-notification-ack-escalation-digest-delivery-ack-escalation-sla-preview-dry-run.json"
...
def main() -> int:
    ...
    unions = {
        "GfisAssistantDks232RoutingQueueNotificationAckEscalationDigestDeliveryAckEscalationSlaBreachReviewResolutionOptionApprovalPacketRoutingQueueNotificationAckEscalationDigestDeliveryAckEscalationSlaPreviewType": policy["sla_types"],
        "GfisAssistantDks232RoutingQueueNotificationAckEscalationDigestDeliveryAckEscalationSlaBreachReviewResolutionOptionApprovalPacketRoutingQueueNotificationAckEscalationDigestDeliveryAckEscalationSlaPreviewStatus": policy["sla_statuses"],
        "GfisAssistantDks232RoutingQueueNotificationAckEscalationDigestDeliveryAckEscalationSlaBreachReviewResolutionOptionApprovalPacketRoutingQueueNotificationAckEscalationDigestDeliveryAckEscalationSlaPreviewDecision": policy["sla_decisions"],
        "GfisAssistantDks232RoutingQueueNotificationAckEscalationDigestDeliveryAckEscalationSlaBreachReviewResolutionOptionApprovalPacketRoutingQueueNotificationAckEscalationDigestDeliveryAckEscalationSlaPreviewScope": policy["sla_scopes"],
        "GfisAssistantDks232RoutingQueueNotificationAckEscalationDigestDeliveryAckEscalationSlaBreachReviewResolutionOptionApprovalPacketRoutingQueueNotificationAckEscalationDigestDeliveryAckEscalationSlaPreviewRisk": policy["sla_risks"],
        "GfisAssistantDks232RoutingQueueNotificationAckEscalationDigestDeliveryAckEscalationSlaBreachReviewResolutionOptionApprovalPacketRoutingQueueNotificationAckEscalationDigestDeliveryAckEscalationSlaPreviewReason": policy["sla_reasons"],
        "GfisAssistantDks232RoutingQueueNotificationAckEscalationDigestDeliveryAckEscalationSlaBreachReviewResolutionOptionApprovalPacketRoutingQueueNotificationAckEscalationDigestDeliveryAckEscalationSlaPreviewBlockedAction": policy["blocked_actions"],
    }
    ...
    counts = {
        ...
        "totalRequiredEvidenceCount": 0, "totalBlockedSlaEscalationCount": 0, "totalSlaWindowMinutes": 0,
    ...
    for preview in previews:
        ...
        if not preview["requiredEvidenceRefs"]:
            failures.append(f"{preview_id}: requiredEvidenceRefs are required")
    ...
    if failures:
        print("gfis_assistant_dks_232_routing_queue_notification_ack_escalation_digest_delivery_ack_escalation_sla_preview=fail")
        for failure in failures:
            print(failure)
        return 1

    print(
        "gfis_assistant_dks_232_routing_queue_notification_ack_escalation_digest_delivery_ack_escalation_sla_preview=pass "
