#!/usr/bin/env python3
"""Validate GFIS Assistant DKS-205 acknowledgement escalation digest delivery preview no-write boundary."""
...
POLICY = ROOT / "okf" / "gfis-assistant-dks-205-routing-queue-notification-acknowledgement-escalation-digest-delivery-ack-escalation-sla-breach-review-resolution-option-approval-packet-routing-queue-notification-acknowledgement-escalation-digest-delivery-preview-policy.yaml"
TYPE_FILE = ROOT / "packages" / "shared" / "src" / "knowledge" / "gfis-assistant-dks-205-routing-queue-notification-acknowledgement-escalation-digest-delivery-ack-escalation-sla-breach-review-resolution-option-approval-packet-routing-queue-notification-acknowledgement-escalation-digest-delivery-preview.ts"
FIXTURE = ROOT / "fixtures" / "gfis" / "gfis-assistant-dks-205-routing-queue-notification-acknowledgement-escalation-digest-delivery-ack-escalation-sla-breach-review-resolution-option-approval-packet-routing-queue-notification-acknowledgement-escalation-digest-delivery-preview-dry-run.json"
...
def main() -> int:
    ...
    unions = {
        "GfisAssistantDks205RoutingQueueNotificationAcknowledgementEscalationDigestDeliveryAckEscalationSlaBreachReviewResolutionOptionApprovalPacketRoutingQueueNotificationAcknowledgementEscalationDigestDeliveryPreviewType": policy["delivery_types"],
        "GfisAssistantDks205RoutingQueueNotificationAcknowledgementEscalationDigestDeliveryAckEscalationSlaBreachReviewResolutionOptionApprovalPacketRoutingQueueNotificationAcknowledgementEscalationDigestDeliveryPreviewStatus": policy["delivery_statuses"],
        "GfisAssistantDks205RoutingQueueNotificationAcknowledgementEscalationDigestDeliveryAckEscalationSlaBreachReviewResolutionOptionApprovalPacketRoutingQueueNotificationAcknowledgementEscalationDigestDeliveryPreviewDecision": policy["delivery_decisions"],
        "GfisAssistantDks205RoutingQueueNotificationAcknowledgementEscalationDigestDeliveryAckEscalationSlaBreachReviewResolutionOptionApprovalPacketRoutingQueueNotificationAcknowledgementEscalationDigestDeliveryPreviewScope": policy["delivery_scopes"],
        "GfisAssistantDks205RoutingQueueNotificationAcknowledgementEscalationDigestDeliveryAckEscalationSlaBreachReviewResolutionOptionApprovalPacketRoutingQueueNotificationAcknowledgementEscalationDigestDeliveryPreviewChannel": policy["delivery_channels"],
        "GfisAssistantDks205RoutingQueueNotificationAcknowledgementEscalationDigestDeliveryAckEscalationSlaBreachReviewResolutionOptionApprovalPacketRoutingQueueNotificationAcknowledgementEscalationDigestDeliveryPreviewPriority": policy["delivery_priorities"],
        "GfisAssistantDks205RoutingQueueNotificationAcknowledgementEscalationDigestDeliveryAckEscalationSlaBreachReviewResolutionOptionApprovalPacketRoutingQueueNotificationAcknowledgementEscalationDigestDeliveryPreviewReason": policy["delivery_reasons"],
        "GfisAssistantDks205RoutingQueueNotificationAcknowledgementEscalationDigestDeliveryAckEscalationSlaBreachReviewResolutionOptionApprovalPacketRoutingQueueNotificationAcknowledgementEscalationDigestDeliveryPreviewBlockedAction": policy["blocked_actions"],
    }
    ...
    counts = {
        ...
        "totalRequiredEvidenceCount": 0, "totalDeliveryReasonCount": 0,
    ...
    for preview in previews:
        ...
        if not preview["requiredEvidenceRefs"] or not preview["deliveryReasonRefs"]:
            failures.append(f"{preview_id}: requiredEvidenceRefs and deliveryReasonRefs are required")
    ...
    if failures:
        print("gfis_assistant_dks_205_routing_queue_notification_acknowledgement_escalation_digest_delivery_ack_escalation_sla_breach_review_resolution_option_approval_packet_routing_queue_notification_acknowledgement_escalation_digest_delivery_preview=fail")
        for failure in failures:
            print(failure)
        return 1

    print(
        "gfis_assistant_dks_205_routing_queue_notification_acknowledgement_escalation_digest_delivery_ack_escalation_sla_breach_review_resolution_option_approval_packet_routing_queue_notification_acknowledgement_escalation_digest_delivery_preview=pass "
        ...
        f"total_channels={actual['totalChannelCount']} total_required_evidence={actual['totalRequiredEvidenceCount']} "
        f"total_delivery_reasons={actual['totalDeliveryReasonCount']} total_blocked_delivery={actual['totalBlockedDeliveryCount']} "
