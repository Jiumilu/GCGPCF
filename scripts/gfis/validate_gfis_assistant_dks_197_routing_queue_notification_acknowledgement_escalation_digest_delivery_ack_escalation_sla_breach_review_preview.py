#!/usr/bin/env python3
"""Validate GFIS Assistant DKS-197 SLA breach review preview no-write boundary."""
...
POLICY = ROOT / "okf" / "gfis-assistant-dks-197-routing-queue-notification-acknowledgement-escalation-digest-delivery-ack-escalation-sla-breach-review-preview-policy.yaml"
TYPE_FILE = ROOT / "packages" / "shared" / "src" / "knowledge" / "gfis-assistant-dks-197-routing-queue-notification-acknowledgement-escalation-digest-delivery-ack-escalation-sla-breach-review-preview.ts"
FIXTURE = ROOT / "fixtures" / "gfis" / "gfis-assistant-dks-197-routing-queue-notification-acknowledgement-escalation-digest-delivery-ack-escalation-sla-breach-review-preview-dry-run.json"
...
def main() -> int:
    ...
    unions = {
        "GfisAssistantDks197RoutingQueueNotificationAcknowledgementEscalationDigestDeliveryAckEscalationSlaBreachReviewPreviewType": policy["breach_review_types"],
        "GfisAssistantDks197RoutingQueueNotificationAcknowledgementEscalationDigestDeliveryAckEscalationSlaBreachReviewPreviewStatus": policy["breach_review_statuses"],
        "GfisAssistantDks197RoutingQueueNotificationAcknowledgementEscalationDigestDeliveryAckEscalationSlaBreachReviewPreviewDecision": policy["breach_review_decisions"],
        "GfisAssistantDks197RoutingQueueNotificationAcknowledgementEscalationDigestDeliveryAckEscalationSlaBreachReviewPreviewScope": policy["breach_review_scopes"],
        "GfisAssistantDks197RoutingQueueNotificationAcknowledgementEscalationDigestDeliveryAckEscalationSlaBreachReviewPreviewSeverity": policy["breach_severities"],
        "GfisAssistantDks197RoutingQueueNotificationAcknowledgementEscalationDigestDeliveryAckEscalationSlaBreachReviewPreviewReason": policy["breach_reasons"],
        "GfisAssistantDks197RoutingQueueNotificationAcknowledgementEscalationDigestDeliveryAckEscalationSlaBreachReviewPreviewBlockedAction": policy["blocked_actions"],
    }
    ...
    if failures:
        print("gfis_assistant_dks_197_routing_queue_notification_acknowledgement_escalation_digest_delivery_ack_escalation_sla_breach_review_preview=fail")
        for failure in failures:
            print(failure)
        return 1

    print(
        "gfis_assistant_dks_197_routing_queue_notification_acknowledgement_escalation_digest_delivery_ack_escalation_sla_breach_review_preview=pass "
