#!/usr/bin/env python3
"""Validate GFIS Assistant DKS-173 routing queue notification acknowledgement escalation digest delivery acknowledgement escalation SLA breach review no-write boundary."""
...
POLICY = ROOT / "okf" / "gfis-assistant-approval-route-ack-escalation-digest-delivery-ack-escalation-sla-breach-review-resolution-option-approval-packet-routing-queue-notification-ack-escalation-digest-delivery-ack-escalation-sla-breach-review-preview-policy.yaml"
TYPE_FILE = ROOT / "packages" / "shared" / "src" / "knowledge" / "gfis-assistant-approval-route-ack-escalation-digest-delivery-ack-escalation-sla-breach-review-resolution-option-approval-packet-routing-queue-notification-ack-escalation-digest-delivery-ack-escalation-sla-breach-review-preview.ts"
FIXTURE = ROOT / "fixtures" / "gfis" / "gfis-assistant-approval-route-ack-escalation-digest-delivery-ack-escalation-sla-breach-review-resolution-option-approval-packet-routing-queue-notification-ack-escalation-digest-delivery-ack-escalation-sla-breach-review-preview-dry-run.json"

NO_WRITE_KEYS = (
    "writesGfis", "writesGpc", "writesErp", "writesMes",
    "writesBreachRecord", "writesDispute", "writesCommitteeCase",
    "writesFreezeRequest", "writesReminder", "writesApprovalRequest",
...
def main() -> int:
    ...
    unions = {
        "GfisAssistantApprovalRouteAckEscalationDigestDeliveryAckEscalationSlaBreachReviewResolutionOptionApprovalPacketRoutingQueueNotificationAckEscalationDigestDeliveryAckEscalationSlaBreachReviewPreviewType": policy["breach_review_types"],
        "GfisAssistantApprovalRouteAckEscalationDigestDeliveryAckEscalationSlaBreachReviewResolutionOptionApprovalPacketRoutingQueueNotificationAckEscalationDigestDeliveryAckEscalationSlaBreachReviewPreviewStatus": policy["breach_review_statuses"],
        "GfisAssistantApprovalRouteAckEscalationDigestDeliveryAckEscalationSlaBreachReviewResolutionOptionApprovalPacketRoutingQueueNotificationAckEscalationDigestDeliveryAckEscalationSlaBreachReviewPreviewDecision": policy["breach_review_decisions"],
        "GfisAssistantApprovalRouteAckEscalationDigestDeliveryAckEscalationSlaBreachReviewResolutionOptionApprovalPacketRoutingQueueNotificationAckEscalationDigestDeliveryAckEscalationSlaBreachReviewPreviewScope": policy["breach_review_scopes"],
        "GfisAssistantApprovalRouteAckEscalationDigestDeliveryAckEscalationSlaBreachReviewResolutionOptionApprovalPacketRoutingQueueNotificationAckEscalationDigestDeliveryAckEscalationSlaBreachReviewPreviewSeverity": policy["breach_severities"],
        "GfisAssistantApprovalRouteAckEscalationDigestDeliveryAckEscalationSlaBreachReviewResolutionOptionApprovalPacketRoutingQueueNotificationAckEscalationDigestDeliveryAckEscalationSlaBreachReviewPreviewReason": policy["breach_reasons"],
        "GfisAssistantApprovalRouteAckEscalationDigestDeliveryAckEscalationSlaBreachReviewResolutionOptionApprovalPacketRoutingQueueNotificationAckEscalationDigestDeliveryAckEscalationSlaBreachReviewPreviewBlockedAction": policy["blocked_actions"],
    }
    ...
    counts = {
        ...
        "totalReviewerCount": 0, "totalEvidenceGapCount": 0,
        "totalBreachReasonCount": 0, "totalBlockedReviewCount": 0,
        "totalOverdueMinutes": 0, "createsBreachRecords": 0,
        "createsDisputes": 0, "createsCommitteeCases": 0,
        "createsFreezeRequests": 0, "createsReminders": 0,
    ...
    false_flags = (
        "createsBreachRecord", "createsDispute", "createsCommitteeCase",
        "createsFreezeRequest", "createsReminder", "createsApprovalRequest",
    ...
    flag_count_keys = {
        "createsBreachRecord": "createsBreachRecords",
        "createsDispute": "createsDisputes",
        "createsCommitteeCase": "createsCommitteeCases",
        "createsFreezeRequest": "createsFreezeRequests",
    ...
    for preview in previews:
        ...
        if not set(preview["slaPreviewRefs"]) <= set(preview["sourceSlaPreviewRefs"]):
            failures.append(f"{preview_id}: slaPreviewRefs must be included in sourceSlaPreviewRefs")
    ...
    if failures:
        print("gfis_assistant_approval_route_ack_escalation_digest_delivery_ack_escalation_sla_breach_review_resolution_option_approval_packet_routing_queue_notification_ack_escalation_digest_delivery_ack_escalation_sla_breach_review_preview=fail")
        for failure in failures:
            print(failure)
        return 1

    print(
        "gfis_assistant_approval_route_ack_escalation_digest_delivery_ack_escalation_sla_breach_review_resolution_option_approval_packet_routing_queue_notification_ack_escalation_digest_delivery_ack_escalation_sla_breach_review_preview=pass "
        ...
        f"creates_breach_records={actual['createsBreachRecords']} creates_disputes={actual['createsDisputes']} "
        f"creates_committee_cases={actual['createsCommitteeCases']} creates_freeze_requests={actual['createsFreezeRequests']} "
        f"creates_reminders={actual['createsReminders']} creates_approval_requests={actual['createsApprovalRequests']} "
        ...
        "writes_gfis=0 writes_gpc=0 writes_erp=0 writes_mes=0 writes_breach_record=0 writes_dispute=0 "
        "writes_committee_case=0 writes_freeze_request=0 writes_reminder=0 writes_approval_request=0 "
