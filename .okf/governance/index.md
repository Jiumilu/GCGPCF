...
| Loop rounds index | `docs/harness/loops/README.md` | `开发/12-GPCF/docs/harness/loops/README.md` |
| Loop state | `docs/harness/loop-state.md` | `开发/12-GPCF/docs/harness/loop-state.md` |
