...
owner: GPCF
kds_space: 开发
kds_path: 开发/12-GPCF/.codex/README.md
...
用途：保存本地技能和 Codex 工作配置，按运行类文档受控。
...
| --- | --- | --- | --- | --- |
| GPCF-DOC-56E7A7A3B5 | Codex 本地配置 | .codex/README.md | GPCF | operational_controlled |
| GPCF-DOC-424C591653 | Codex 本地技能 | .codex/skills/README.md | GPCF | operational_controlled |
