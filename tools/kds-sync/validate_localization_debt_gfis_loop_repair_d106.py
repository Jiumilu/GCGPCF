#!/usr/bin/env python3
"""Validate D106 scoped GFIS Loop localization repair."""
...
EVIDENCE_JSON = ROOT / "docs/harness/evidence/localization-debt-gfis-loop-repair-d106-20260622.json"
EVIDENCE_MD = ROOT / "docs/harness/evidence/localization-debt-gfis-loop-repair-d106-20260622.md"
LOOP_MD = ROOT / "docs/harness/loops/loop-round-GPCF-GCKF-P0-D106-001.md"


def fail(message: str) -> None:
    print(f"localization_debt_gfis_loop_repair_d106=fail reason={message}")
    sys.exit(1)
...
def main() -> None:
    if not EVIDENCE_JSON.exists() or not EVIDENCE_MD.exists() or not LOOP_MD.exists():
        fail("missing_d106_evidence_or_loop")
    ...
    if evidence.get("changed_line_items") != 240:
        fail("changed_line_items_not_240")
    ...
    if delta.get("all_repo_findings") != -41:
    ...
    print("localization_debt_gfis_loop_repair_d106=pass")
