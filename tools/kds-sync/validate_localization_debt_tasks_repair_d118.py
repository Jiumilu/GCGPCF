#!/usr/bin/env python3
"""Validate D118 scoped tasks localization repair."""
...
EVIDENCE_JSON = ROOT / "docs/harness/evidence/localization-debt-tasks-repair-d118-20260622.json"
EVIDENCE_MD = ROOT / "docs/harness/evidence/localization-debt-tasks-repair-d118-20260622.md"
LOOP_MD = ROOT / "docs/harness/loops/loop-round-GPCF-GCKF-P0-D118-001.md"


def fail(message: str) -> None:
    print(f"localization_debt_tasks_repair_d118=fail reason={message}")
    sys.exit(1)
...
def main() -> None:
    if not EVIDENCE_JSON.exists() or not EVIDENCE_MD.exists() or not LOOP_MD.exists():
        fail("missing_d118_evidence_or_loop")
    ...
    if evidence.get("changed_line_items") != 100:
        fail("changed_line_items_not_100")
    ...
    print("localization_debt_tasks_repair_d118=pass")
