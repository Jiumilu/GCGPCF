...
EVIDENCE_JSON = ROOT / "docs/harness/evidence/was-real-source-record-candidate-precheck-execution-005-20260622.json"
EVIDENCE_MD = ROOT / "docs/harness/evidence/was-real-source-record-candidate-precheck-execution-005-20260622.md"
LOOP_ROUND = ROOT / "docs/harness/loops/loop-round-GPCF-ONTOLOGY-WAS-REAL-SOURCE-RECORD-CANDIDATE-PRECHECK-EXECUTION-005.md"
INTAKE_DIR = ROOT / "docs/harness/intake"
TEMPLATE = INTAKE_DIR / "was-real-source-record-candidate-template.yaml"
POSITIVE = ROOT / "fixtures/was/p4-candidate-precheck-execution-005-positive-hold.json"
NEGATIVE = ROOT / "fixtures/was/p4-candidate-precheck-execution-005-negative-false-promotion.json"
...
def main() -> int:
    ...
    require(evidence.get("evidence_id") == "WAS-REAL-SOURCE-RECORD-CANDIDATE-PRECHECK-EXECUTION-005-20260622", "invalid evidence id")
    require(evidence.get("round_id") == "GPCF-ONTOLOGY-WAS-REAL-SOURCE-RECORD-CANDIDATE-PRECHECK-EXECUTION-005", "invalid round id")
    require(evidence.get("executed_round") == "GPCF-ONTOLOGY-WAS-REAL-SOURCE-RECORD-CANDIDATE-PRECHECK-001", "executed round mismatch")
    require(evidence.get("source_round") == "GPCF-ONTOLOGY-WAS-REAL-SOURCE-RECORD-MONITOR-040", "source round mismatch")
    ...
    require("GPCF-ONTOLOGY-WAS-REAL-SOURCE-RECORD-MONITOR-041" in evidence_md, "next round missing from evidence md")
    ...
    require(any("was_real_source_record_monitor_040=pass" in output for output in command_outputs), "monitor 040 output missing")

    print(
        "was_real_source_record_candidate_precheck_execution_005=pass "
        ...
        "production_ready=false next_round=GPCF-ONTOLOGY-WAS-REAL-SOURCE-RECORD-MONITOR-041"
    )
    return 0
