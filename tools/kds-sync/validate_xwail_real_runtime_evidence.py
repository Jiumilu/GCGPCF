#!/usr/bin/env python3
"""Validate XWAIL real runtime baseline evidence boundaries."""
...
EVIDENCE = ROOT / "docs/harness/XWAIL/evidence/xwail-real-runtime-baseline-20260624.md"
README = ROOT / "docs/harness/XWAIL/README.md"
EVIDENCE_README = ROOT / "docs/harness/XWAIL/evidence/README.md"
...
REQUIRED_REGISTER_TOKENS = [
    "xwail-real-runtime-baseline-20260624.md",
    "xwail_governance_evidence = verified",
    "xwail_runtime_evidence = repair_required",
    "xwail_repair_required = validator_commands_missing",
...
def main() -> int:
    failures: list[str] = []
    warnings = [
        "XWAIL evidence proves governance alignment and missing runtime commands; Validator implementation remains pending.",
    ]
    ...
    for token in REQUIRED_EVIDENCE_TOKENS:
        if token not in evidence_text:
            failures.append(f"missing token in XWAIL evidence: {token}")
    ...
    result = {
        "gate": "xwail_real_runtime_evidence",
