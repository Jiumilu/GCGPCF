#!/usr/bin/env python3
"""Validate D110 scoped evidence-boundary localization repair."""
...
EVIDENCE_JSON = ROOT / "docs/harness/evidence/localization-debt-evidence-boundary-repair-d110-20260622.json"
EVIDENCE_MD = ROOT / "docs/harness/evidence/localization-debt-evidence-boundary-repair-d110-20260622.md"
LOOP_MD = ROOT / "docs/harness/loops/loop-round-GPCF-GCKF-P0-D110-001.md"


def fail(message: str) -> None:
    print(f"localization_debt_evidence_boundary_repair_d110=fail reason={message}")
    sys.exit(1)
...
def main() -> None:
    if not EVIDENCE_JSON.exists() or not EVIDENCE_MD.exists() or not LOOP_MD.exists():
        fail("missing_d110_evidence_or_loop")
    ...
    if evidence.get("changed_line_items") != 11:
        fail("changed_line_items_not_11")
    ...
    print("localization_debt_evidence_boundary_repair_d110=pass")
