#!/usr/bin/env python3
"""Validate D112 scoped WAS monitor 044 localization repair."""
...
EVIDENCE_JSON = ROOT / "docs/harness/evidence/localization-debt-was-monitor-044-repair-d112-20260622.json"
EVIDENCE_MD = ROOT / "docs/harness/evidence/localization-debt-was-monitor-044-repair-d112-20260622.md"
LOOP_MD = ROOT / "docs/harness/loops/loop-round-GPCF-GCKF-P0-D112-001.md"


def fail(message: str) -> None:
    print(f"localization_debt_was_monitor_044_repair_d112=fail reason={message}")
    sys.exit(1)
...
def main() -> None:
    if not EVIDENCE_JSON.exists() or not EVIDENCE_MD.exists() or not LOOP_MD.exists():
        fail("missing_d112_evidence_or_loop")
    ...
    if evidence.get("changed_line_items") != 4:
        fail("changed_line_items_not_4")
    ...
    print("localization_debt_was_monitor_044_repair_d112=pass")
