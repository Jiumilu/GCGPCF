#!/usr/bin/env python3
"""Validate the 2026-06-26 project-group P0-B project validation evidence."""
...
EVIDENCE = ROOT / "docs/harness/evidence/globalcloud-project-group-p0b-project-validation-20260626.md"
LOOP_ROUND = ROOT / "docs/harness/loops/loop-round-GPCF-PROJECT-GROUP-P0B-PROJECT-VALIDATION-001.md"
...
REQUIRED_TOKENS = [
    ...
    "GlobalCloud Studio",
    "dev_validation_pass",
    "dev_validation_pass_with_knowledge_queue",
    "dev_validation_pass_with_dist_review",
    "dev_validation_pass_with_release_review",
]
...
def main() -> int:
    ...
    for project in VALIDATED_PROJECTS:
        if project not in evidence:
            failures.append(f"missing validated project: {project}")
    ...
    result = {
        "project_group_p0b_project_validation": "pass" if not failures else "fail",
        "validated_projects": len(VALIDATED_PROJECTS),
        "git_gate": gate,
        "accepted": False,
        "integrated": False,
        "production_ready": False,
