#!/usr/bin/env python3
"""Validate D104 scoped GFIS Loop localization repair."""
...
EVIDENCE_JSON = ROOT / "docs/harness/evidence/localization-debt-gfis-loop-repair-d104-20260622.json"
EVIDENCE_MD = ROOT / "docs/harness/evidence/localization-debt-gfis-loop-repair-d104-20260622.md"
LOOP_MD = ROOT / "docs/harness/loops/loop-round-GPCF-GCKF-P0-D104-001.md"


def fail(message: str) -> None:
    print(f"localization_debt_gfis_loop_repair_d104=fail reason={message}")
    sys.exit(1)
...
def main() -> None:
    ...
    if evidence.get("changed_line_items") != 216:
        fail("changed_line_items_not_216")
    ...
    if delta.get("target_file_findings") != -15:
        fail("unexpected_target_delta")
    if delta.get("all_repo_findings") != -15:
    ...
    print("localization_debt_gfis_loop_repair_d104=pass")
