#!/usr/bin/env python3
"""Validate D100 scoped KDS evidence localization repair."""
...
EVIDENCE_JSON = ROOT / "docs/harness/evidence/localization-debt-kds-evidence-repair-d100-20260622.json"
EVIDENCE_MD = ROOT / "docs/harness/evidence/localization-debt-kds-evidence-repair-d100-20260622.md"
LOOP_MD = ROOT / "docs/harness/loops/loop-round-GPCF-GCKF-P0-D100-001.md"


def fail(message: str) -> None:
    print(f"localization_debt_kds_evidence_repair_d100=fail reason={message}")
    sys.exit(1)
...
def main() -> None:
    if not EVIDENCE_JSON.exists() or not EVIDENCE_MD.exists() or not LOOP_MD.exists():
        fail("missing_d100_evidence_or_loop")
    ...
    if evidence.get("changed_line_items") != 50:
        fail("changed_line_items_not_50")
    ...
    print("localization_debt_kds_evidence_repair_d100=pass")
