#!/usr/bin/env python3
"""Validate D116 scoped WAS monitor 046 localization repair."""
...
EVIDENCE_JSON = ROOT / "docs/harness/evidence/localization-debt-was-monitor-046-repair-d116-20260622.json"
EVIDENCE_MD = ROOT / "docs/harness/evidence/localization-debt-was-monitor-046-repair-d116-20260622.md"
LOOP_MD = ROOT / "docs/harness/loops/loop-round-GPCF-GCKF-P0-D116-001.md"


def fail(message: str) -> None:
    print(f"localization_debt_was_monitor_046_repair_d116=fail reason={message}")
    sys.exit(1)
...
def main() -> None:
    if not EVIDENCE_JSON.exists() or not EVIDENCE_MD.exists() or not LOOP_MD.exists():
        fail("missing_d116_evidence_or_loop")
    ...
    print("localization_debt_was_monitor_046_repair_d116=pass")
