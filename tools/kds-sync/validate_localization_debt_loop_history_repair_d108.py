#!/usr/bin/env python3
"""Validate D108 scoped loop-history localization repair."""
...
EVIDENCE_JSON = ROOT / "docs/harness/evidence/localization-debt-loop-history-repair-d108-20260622.json"
EVIDENCE_MD = ROOT / "docs/harness/evidence/localization-debt-loop-history-repair-d108-20260622.md"
LOOP_MD = ROOT / "docs/harness/loops/loop-round-GPCF-GCKF-P0-D108-001.md"


def fail(message: str) -> None:
    print(f"localization_debt_loop_history_repair_d108=fail reason={message}")
    sys.exit(1)
...
def main() -> None:
    if not EVIDENCE_JSON.exists() or not EVIDENCE_MD.exists() or not LOOP_MD.exists():
        fail("missing_d108_evidence_or_loop")
    ...
    if evidence.get("changed_line_items") != 14:
        fail("changed_line_items_not_14")
    ...
    print("localization_debt_loop_history_repair_d108=pass")
