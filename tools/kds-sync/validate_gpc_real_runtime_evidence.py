#!/usr/bin/env python3
"""Validate GPC real runtime baseline evidence boundaries."""
...
EVIDENCE = ROOT / "docs/harness/GPC/evidence/gpc-real-runtime-baseline-20260624.md"
README = ROOT / "docs/harness/GPC/README.md"
EVIDENCE_README = ROOT / "docs/harness/GPC/evidence/README.md"
...
REQUIRED_EVIDENCE_TOKENS = [
    ...
    "GCFIS desk reachable: http://127.0.0.1:8080/desk",
...
REQUIRED_REGISTER_TOKENS = [
    "gpc-real-runtime-baseline-20260624.md",
    "gpc_runtime_evidence = partial_verified",
    "gpc_interface_evidence = partial_verified",
    "gpc_l3_l4_evidence = verified",
    "gpc_repair_required = readme_external_evidence_browser",
    "validate_gpc_l3_harness.py",
    "validate_gpc_l4_platform_contract.py",
    "npm run quality:ops",
]
...
def main() -> int:
    failures: list[str] = []
    warnings = [
        "GPC evidence is partial: runtime/API/L3/L4 evidence exists, but external evidence, README index, browser tests, delivery, and customer acceptance remain open.",
    ]
    ...
    for token in REQUIRED_EVIDENCE_TOKENS:
        if token not in evidence_text:
            failures.append(f"missing token in GPC evidence: {token}")
    ...
    result = {
        "gate": "gpc_real_runtime_evidence",
