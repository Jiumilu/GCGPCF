#!/usr/bin/env python3
"""Validate D117 scoped unified-permission-middleware localization repair."""
...
EVIDENCE_JSON = ROOT / "docs/harness/evidence/localization-debt-unified-permission-middleware-repair-d117-20260622.json"
EVIDENCE_MD = ROOT / "docs/harness/evidence/localization-debt-unified-permission-middleware-repair-d117-20260622.md"
LOOP_MD = ROOT / "docs/harness/loops/loop-round-GPCF-GCKF-P0-D117-001.md"


def fail(message: str) -> None:
    print(f"localization_debt_unified_permission_middleware_repair_d117=fail reason={message}")
    sys.exit(1)
...
def main() -> None:
    if not EVIDENCE_JSON.exists() or not EVIDENCE_MD.exists() or not LOOP_MD.exists():
        fail("missing_d117_evidence_or_loop")
    ...
    print("localization_debt_unified_permission_middleware_repair_d117=pass")
