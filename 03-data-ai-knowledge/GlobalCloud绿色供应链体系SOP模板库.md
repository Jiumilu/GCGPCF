...
5. 平台型 SOP 默认以 `GPC-Native` 为主责系统；宪法要求通过证据要求、治理确认点和状态升级门进入 SOP 模板，而不是直接替代业务步骤。
...
| ownerSystem | GFIS / GPC-Native / PVAOS / WAES / Edge / Brain / XiaoC / Hermes / XGD |
| ownerRole | 主责角色 |
...
| 一链多厂分单 SOP | GPC-Native / GFIS | FactoryAllocation、CapacityCommitment |
...
| 多链多厂协同 SOP | GPC-Native / WAES | 跨链隔离、经营分析 |
