---
doc_id: GPCF-DOC-PROJECT-MASTER-PLAN-BATCH-2-AUTH-REQUEST-20260624
title: 项目总体方案第二批批量更新授权请求
project: WAES
related_projects: [GPC, WAES, PKC, XiaoC, XGD, XiaoG, MMC, GPCF]
domain: governance
status: controlled
version: v1.0
owner: WAES
kds_space: 开发
kds_path: 开发/91-治理与验收/02-governance/project-master-plan-batch-2-authorization-request.md
source_path: 02-governance/project-master-plan-batch-2-authorization-request.md
...
batch_projects:
  ...
  - GlobalCloud XiaoC
  - GlobalCloud XiaoG
confirmation_text: 我确认开始第二批项目总体方案批量建立，范围为 MMC、PKC、SOP、XGD、XiaoC、XiaoG。
confirmation_time: 2026-06-24
```
...
|---|---|---|---|---|
| GlobalCloud MMC | 缺少唯一总体方案 | 新建 `GlobalCloud MMC 总体方案.md` | 是 | 是 |
| GlobalCloud PKC | 缺少唯一总体方案 | 新建 `GlobalCloud PKC 总体方案.md` | 是 | 是 |
| GlobalCloud SOP | 缺少唯一总体方案，且缺少 `AGENTS.md` | 新建 `AGENTS.md` 与 `GlobalCloud SOP 总体方案.md` | 是 | 是 |
| GlobalCloud XGD | 缺少唯一总体方案 | 新建 `GlobalCloud XGD 总体方案.md` | 是 | 是 |
| GlobalCloud XiaoC | 缺少唯一总体方案 | 新建 `GlobalCloud XiaoC 总体方案.md` | 是 | 是 |
| GlobalCloud XiaoG | 缺少唯一总体方案 | 新建 `GlobalCloud XiaoG 总体方案.md` | 是 | 是 |
...
```text
我确认开始第二批项目总体方案批量建立，范围为 MMC、PKC、SOP、XGD、XiaoC、XiaoG。
```
