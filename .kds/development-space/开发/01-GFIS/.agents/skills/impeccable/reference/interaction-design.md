...
owner: GPCF
kds_space: 开发
kds_path: 开发/12-GPCF/.agents/skills/impeccable/reference/interaction-design.md
source_path: .agents/skills/impeccable/reference/interaction-design.md
