---
doc_id: GPCF-DOC-9AF8C291EB
title: "Acceptance Matrix: gbrain-admin-console-v1"
project: WAES
...
owner: WAES
kds_space: 开发
kds_path: 开发/92-证据与会话归档/.harness/runs/gbrain-admin-console-v1-20260610-201442/acceptance-matrix.md
source_path: .harness/runs/gbrain-admin-console-v1-20260610-201442/acceptance-matrix.md
