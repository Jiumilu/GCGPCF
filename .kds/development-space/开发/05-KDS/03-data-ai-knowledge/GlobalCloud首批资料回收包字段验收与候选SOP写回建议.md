...
本文只定义字段、验收、候选写回和关闭模板。本文不代表真实资料已经收到，不代表资料已经通过验收，不代表 GFIS、GPC、PVAOS 或其它业务主账已经写入，不代表真实 KDS API 已同步，不代表积分、收益、AI 额度、悬赏、争议、参数或 SOP 已确认生效。
