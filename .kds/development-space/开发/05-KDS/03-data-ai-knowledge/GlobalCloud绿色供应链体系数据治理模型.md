---
doc_id: GPCF-DOC-0962BEDB78
title: GlobalCloud 绿色供应链体系数据治理模型
project: KDS
...
owner: KDS
kds_space: 开发
kds_path: 开发/05-KDS/03-data-ai-knowledge/GlobalCloud绿色供应链体系数据治理模型.md
source_path: 03-data-ai-knowledge/GlobalCloud绿色供应链体系数据治理模型.md
...
1. 主责系统唯一：GFIS、GPC、PVAOS、WAES、Brain、Edge 各自负责自己的事实。
2. 事件是事实通知，不是远程命令。
...
| 层 | 作用 | 主要组件 |
|---|---|---|
| 业务事实层 | 产生真实业务事实 | PVAOS / GPC / GFIS / Edge |
...
1. 业务主账库：由 `PVAOS / GPC / GFIS` 各自独立维护。
