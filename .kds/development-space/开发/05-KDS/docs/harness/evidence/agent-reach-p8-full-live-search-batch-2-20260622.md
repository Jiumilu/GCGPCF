---
doc_id: GPCF-DOC-AGENT-REACH-P8-FULL-LIVE-SEARCH-BATCH-2-20260622
title: Agent-Reach P8 全量真实搜索批次 2 证据 2026-06-22
project: KDS
...
owner: KDS
kds_space: 开发
kds_path: 开发/05-KDS/docs/harness/evidence/agent-reach-p8-full-live-search-batch-2-20260622.md
source_path: docs/harness/evidence/agent-reach-p8-full-live-search-batch-2-20260622.md
...
# Agent-Reach P8 全量真实搜索批次 2 证据 2026-06-22
...
- query_error_count: `0`
- average_overall_score: `0.7621`
- minimum_candidate_overall_score: `0.65`
