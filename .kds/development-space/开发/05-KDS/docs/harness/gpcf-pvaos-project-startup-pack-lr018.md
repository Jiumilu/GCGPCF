...
owner: KDS
kds_space: 开发
kds_path: 开发/05-KDS/docs/harness/gpcf-pvaos-project-startup-pack-lr018.md
source_path: docs/harness/gpcf-pvaos-project-startup-pack-lr018.md
...
| 本次 L3 计数 | 2/15 |
| 当前状态上限 | `partial` |
| 目标 | 为 PVAOS 形成 Manifest、loop-state、evidence-index 的受控启动要求。 |
| 下一轮 | GPCF-CF-LR-019 |
...
| 输出项 | 路径或状态 |
|---|---|
| 本轮受控文档 | `docs/harness/gpcf-pvaos-project-startup-pack-lr018.md` |
| Loop record | `docs/harness/loops/loop-round-GPCF-CF-LR-018.md` |
