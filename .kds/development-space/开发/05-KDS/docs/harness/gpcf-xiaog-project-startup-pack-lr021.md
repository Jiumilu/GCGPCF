...
owner: KDS
kds_space: 开发
kds_path: 开发/05-KDS/docs/harness/gpcf-xiaog-project-startup-pack-lr021.md
source_path: docs/harness/gpcf-xiaog-project-startup-pack-lr021.md
...
| 本次 L3 计数 | 5/15 |
| 当前状态上限 | `partial` |
| 目标 | 为 XiaoG 轻量执行入口形成 Manifest 与首轮证据要求。 |
| 下一轮 | GPCF-CF-LR-022 |
...
| 输出项 | 路径或状态 |
|---|---|
| 本轮受控文档 | `docs/harness/gpcf-xiaog-project-startup-pack-lr021.md` |
| Loop record | `docs/harness/loops/loop-round-GPCF-CF-LR-021.md` |
