---
doc_id: GPCF-DOC-1A44A3E539
title: KDS 本地镜像 dry-run 同步包
project: KDS
...
owner: KDS
kds_space: 开发
kds_path: 开发/05-KDS/docs/harness/gpcf-kds-local-mirror-dryrun-package-lr006.md
source_path: docs/harness/gpcf-kds-local-mirror-dryrun-package-lr006.md
...
# KDS 本地镜像 dry-run 同步包

## Round

| 字段 | 值 |
|---|---|
| Round ID | `GPCF-CF-LR-006` |
| 模式 | Loop L3 托管冲刺模式 |
| 本次 L3 计数 | 5/15 |
| 当前状态上限 | `partial` |
| 目标 | 在 TOKEN 暂缓前提下形成只读/本地镜像同步证据包。 |
| 下一轮 | GPCF-CF-LR-007 |
...
| 输出项 | 路径或状态 |
|---|---|
| 本轮受控文档 | `docs/harness/gpcf-kds-local-mirror-dryrun-package-lr006.md` |
| Loop record | `docs/harness/loops/loop-round-GPCF-CF-LR-006.md` |
