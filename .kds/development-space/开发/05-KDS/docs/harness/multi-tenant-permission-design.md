---
doc_id: GPCF-DOC-27101F3BEB
title: Brain 多租户知识库权限体系 — v3.1.1 Implementation Patch
project: KDS
...
owner: KDS
kds_space: 开发
kds_path: 开发/05-KDS/docs/harness/multi-tenant-permission-design.md
source_path: docs/harness/multi-tenant-permission-design.md
