...
owner: KDS
kds_space: 开发
kds_path: 开发/05-KDS/docs/harness/gpcf-dependency-risk-rollback-register-lr011.md
source_path: docs/harness/gpcf-dependency-risk-rollback-register-lr011.md
...
| 字段 | 值 |
|---|---|
| Round ID | `GPCF-CF-LR-011` |
| 模式 | Loop L3 托管冲刺模式 |
| 本次 L3 计数 | 10/15 |
| 当前状态上限 | `partial` |
| 目标 | 梳理 GFIS、WAES、GPC、KDS、Finance 依赖与回滚路径。 |
| 下一轮 | GPCF-CF-LR-012 |
...
| 输出项 | 路径或状态 |
|---|---|
| 本轮受控文档 | `docs/harness/gpcf-dependency-risk-rollback-register-lr011.md` |
| Loop record | `docs/harness/loops/loop-round-GPCF-CF-LR-011.md` |
