...
owner: KDS
kds_space: 开发
kds_path: 开发/05-KDS/docs/harness/gpcf-loop-metrics-calibration-lr009.md
source_path: docs/harness/gpcf-loop-metrics-calibration-lr009.md
...
| 本次 L3 计数 | 8/15 |
| 当前状态上限 | `partial` |
| 目标 | 把轮次预算、门禁通过率、证据完整率、阻塞类型纳入量化指标。 |
| 下一轮 | GPCF-CF-LR-010 |
...
| 输出项 | 路径或状态 |
|---|---|
| 本轮受控文档 | `docs/harness/gpcf-loop-metrics-calibration-lr009.md` |
| Loop record | `docs/harness/loops/loop-round-GPCF-CF-LR-009.md` |
