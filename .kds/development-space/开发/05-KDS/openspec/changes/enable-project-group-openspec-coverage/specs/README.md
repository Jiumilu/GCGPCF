...
owner: KDS
kds_space: 开发
kds_path: 开发/05-KDS/openspec/changes/enable-project-group-openspec-coverage/specs/README.md
source_path: openspec/changes/enable-project-group-openspec-coverage/specs/README.md
...
目录：`openspec/changes/enable-project-group-openspec-coverage/specs`
