...
- 将 coverage、scenario profile matrix、WAES/KDS/RAG/writeback gate pack、project-group ontology registry、waiting-room、completion-audit、status-refresh、source-record monitor 001-083、candidate precheck execution 001-008 纳入覆盖。
