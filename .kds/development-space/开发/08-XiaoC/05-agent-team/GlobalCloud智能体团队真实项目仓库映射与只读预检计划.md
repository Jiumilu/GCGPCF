---
doc_id: GPCF-DOC-D83CE73173
title: GlobalCloud 智能体团队真实项目仓库映射与只读预检计划
project: XiaoC
...
owner: XiaoC
kds_space: 开发
kds_path: 开发/08-XiaoC/05-agent-team/GlobalCloud智能体团队真实项目仓库映射与只读预检计划.md
source_path: 05-agent-team/GlobalCloud智能体团队真实项目仓库映射与只读预检计划.md
...
| GPC（现有原型） | `/Users/lujunxiang/Projects/GlobalCloud GPC` | `19.0` | `ahead 18`，有未跟踪标准化文件 | `origin=odoo/odoo`，`fork=Jiumilu/odoo` | 仅作为 Odoo 原型只读预检，不代表 GPC 目标平台已完成 |
...
- 专项范围：PVAOS 生态入口包 + GPC 运营协同包 + PKC 个人知识工作台包
- 主仓库：
  - `/Users/lujunxiang/Documents/Codex Space/PVAOS`
  - `/Users/lujunxiang/Projects/GlobalCloud GPC`
- 只读辅助证据：
  - `/Users/lujunxiang/Documents/GlobalCloud智慧工厂/ADR-GPC从Odoo二开调整为原生公共服务平台.md`
...
- 专项范围：XiaoC（蚁后）+ Hermes/XGD（大象）+ XiaoG AI 服务包、Brain 智能知识平台包
- 主仓库：
...
| 链同 | PVAOS 组织/项目/伙伴入口 | GPC 原型中订单/ASN/预约/运输/POD 相关实现 | GPC 与 Odoo 原型切换边界 |
