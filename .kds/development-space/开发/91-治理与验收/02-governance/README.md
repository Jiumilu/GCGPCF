...
用途：保存状态门控、证据治理、实施准入、工具使用、成本控制和全过程交付规范。

KDS 空间：`开发`

KDS 路径前缀：`开发/12-GPCF/02-governance/`
...
| GPCF-DOC-A437BDA6F5 | GlobalCloud 智能体团队模型使用治理与成本控制机制 | 02-governance/GlobalCloud智能体团队模型使用治理与成本控制机制.md | WAES | controlled |
| GPCF-DOC-2469340C52 | GlobalCloud智能体团队软件全过程实施与交付控制规范 | 02-governance/GlobalCloud智能体团队软件全过程实施与交付控制规范.md | GPCF | controlled |
| GPCF-DOC-39CC074588 | GlobalCloud智能体团队运行与实施环境总体规范 | 02-governance/GlobalCloud智能体团队运行与实施环境总体规范.md | WAES | controlled |
| GPCF-DOC-16A6E29BA0 | GlobalCloud绿色供应链体系交付物完成判定规范 | 02-governance/GlobalCloud绿色供应链体系交付物完成判定规范.md | GPCF | controlled |
| GPCF-DOC-12F3EAB4C6 | GlobalCloud绿色供应链体系动运转达标标准与质量门禁 | 02-governance/GlobalCloud绿色供应链体系动运转达标标准与质量门禁.md | GPCF | controlled |
| GPCF-DOC-1139BD0025 | GlobalCloud绿色供应链体系实施过程控制规范清单 | 02-governance/GlobalCloud绿色供应链体系实施过程控制规范清单.md | GPCF | controlled |
| GPCF-DOC-22B59B08B7 | GlobalCloud绿色供应链体系实施项目控制与量化机制 | 02-governance/GlobalCloud绿色供应链体系实施项目控制与量化机制.md | GPCF | controlled |
| GPCF-DOC-4300D04C44 | GlobalCloud 绿色供应链体系模块实施分级判定表 | 02-governance/GlobalCloud绿色供应链体系模块实施分级判定表.md | WAES | controlled |
| GPCF-DOC-670FDF1C79 | GlobalCloud 绿色供应链体系测试与验证规范 | 02-governance/GlobalCloud绿色供应链体系测试与验证规范.md | WAES | controlled |
| GPCF-DOC-5D55FFB7D9 | GlobalCloud绿色供应链体系状态升级与验收放行规范 | 02-governance/GlobalCloud绿色供应链体系状态升级与验收放行规范.md | WAES | controlled |
...
| GPCF-DOC-2BBAE6E546 | GlobalCloud项目群Headroom接入应用与成本评估模型 | 02-governance/GlobalCloud项目群Headroom接入应用与成本评估模型.md | GPCF | controlled |
...
| GPCF-DOC-F150434D98 | GlobalCloud项目群文档与软件中文化治理规范 | 02-governance/GlobalCloud项目群文档与软件中文化治理规范.md | WAES | controlled |
...
| GPCF-DOC-LOOP-GATE-CLASSIFICATION-V11 | LOOP Gate Classification | 02-governance/loop/LOOP_GATE_CLASSIFICATION.md | WAES | controlled |
| GPCF-DOC-FE20CDD358 | Loop Governance Dashboard | 02-governance/loop/LOOP_GOVERNANCE_DASHBOARD.md | WAES | controlled |
| GPCF-DOC-07906C7E54 | LOOP Governance Efficiency Debt Backlog | 02-governance/loop/LOOP_GOVERNANCE_EFFICIENCY_DEBT_BACKLOG.md | WAES | controlled |
...
| GPCF-DOC-8A21A00749 | Loop 治理轮次复核计划 | 02-governance/loop/LOOP_GOVERNANCE_ROUND_REVIEW_PLAN.md | WAES | controlled |
| GPCF-DOC-LOOP-V11-SLIMMING-DELIVERY-RECOVERY | LOOP v1.1 治理瘦身与交付恢复基线 | 02-governance/loop/LOOP_GOVERNANCE_SLIMMING_AND_DELIVERY_RECOVERY.md | WAES | controlled |
