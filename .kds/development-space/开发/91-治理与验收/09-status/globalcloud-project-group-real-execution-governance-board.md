...
| 依赖链 | 当前状态 | 风险 | 下一步 |
|---|---|---|---|
| `WAES -> XWAIL -> AaaS` | `partial_verified / repair_required` | XWAIL 最小 Validator/XAP 已在 local dev 验证，AaaS 服务运行命令仍缺失，WAES 综合检查仍受 lint 与授权边界阻断 | 下一步补 AaaS ServicePackage/Metering/SLA/EvidenceRequirement 最小 runtime，或在用户授权后修复 WAES lint |
