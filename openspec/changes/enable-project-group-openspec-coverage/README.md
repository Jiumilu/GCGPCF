---
doc_id: GPCF-DOC-15FFD3BE22
title: enable-project-group-openspec-coverage
project: KDS
...
owner: KDS
kds_space: 开发
kds_path: 开发/05-KDS/openspec/changes/enable-project-group-openspec-coverage/README.md
source_path: openspec/changes/enable-project-group-openspec-coverage/README.md
...
# enable-project-group-openspec-coverage

目录：`openspec/changes/enable-project-group-openspec-coverage`
