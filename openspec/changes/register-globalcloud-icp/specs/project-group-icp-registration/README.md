---
doc_id: GPCF-DOC-FB59167101
title: project-group-icp-registration
project: KDS
...
owner: KDS
kds_space: 开发
kds_path: 开发/05-KDS/openspec/changes/register-globalcloud-icp/specs/project-group-icp-registration/README.md
source_path: openspec/changes/register-globalcloud-icp/specs/project-group-icp-registration/README.md
...
# project-group-icp-registration

目录：`openspec/changes/register-globalcloud-icp/specs/project-group-icp-registration`
