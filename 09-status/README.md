...
用途：保存项目状态矩阵、项目主线矩阵、文档控制清单和 KDS 同步台账。

KDS 空间：`开发`

KDS 路径前缀：`开发/12-GPCF/09-status/`
...
| GPCF-DOC-6630DBEA9D | GlobalCloud 项目群中文化治理报告 | 09-status/globalcloud-chinese-localization-governance-report.md | GPCF | controlled |
