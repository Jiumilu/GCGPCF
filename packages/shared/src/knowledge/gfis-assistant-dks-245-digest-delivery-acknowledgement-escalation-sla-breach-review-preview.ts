...
export type GfisAssistantDks245DigestDeliveryAcknowledgementEscalationSlaBreachReviewPreviewType =
...
export type GfisAssistantDks245DigestDeliveryAcknowledgementEscalationSlaBreachReviewPreviewStatus =
...
export type GfisAssistantDks245DigestDeliveryAcknowledgementEscalationSlaBreachReviewPreviewDecision =
...
export type GfisAssistantDks245DigestDeliveryAcknowledgementEscalationSlaBreachReviewPreviewScope =
  | "team_internal"
  | "project_internal"
  | "governance_review"
  | "external_blocked"
...
export type GfisAssistantDks245DigestDeliveryAcknowledgementEscalationSlaBreachReviewPreviewSeverity =
  | "low_candidate"
  | "medium_candidate"
  | "high_candidate"
...
export type GfisAssistantDks245DigestDeliveryAcknowledgementEscalationSlaBreachReviewPreviewReason =
...
export type GfisAssistantDks245DigestDeliveryAcknowledgementEscalationSlaBreachReviewPreviewBlockedAction =
...
export interface GfisAssistantDks245DigestDeliveryAcknowledgementEscalationSlaBreachReviewPreviewNoWrite {
  writesGfis: 0;
  writesGpc: 0;
  writesErp: 0;
  writesMes: 0;
...
export interface GfisAssistantDks245DigestDeliveryAcknowledgementEscalationSlaBreachReviewPreview {
  ...
  breachReviewType: GfisAssistantDks245DigestDeliveryAcknowledgementEscalationSlaBreachReviewPreviewType;
  breachReviewStatus: GfisAssistantDks245DigestDeliveryAcknowledgementEscalationSlaBreachReviewPreviewStatus;
  breachReviewDecision: GfisAssistantDks245DigestDeliveryAcknowledgementEscalationSlaBreachReviewPreviewDecision;
  breachReviewScope: GfisAssistantDks245DigestDeliveryAcknowledgementEscalationSlaBreachReviewPreviewScope;
  breachSeverity: GfisAssistantDks245DigestDeliveryAcknowledgementEscalationSlaBreachReviewPreviewSeverity;
  overdueMinutes: number;
  candidateReviewerRefs: string[];
  evidenceGapRefs: string[];
  breachReasonRefs: GfisAssistantDks245DigestDeliveryAcknowledgementEscalationSlaBreachReviewPreviewReason[];
  ...
  blockedActions: GfisAssistantDks245DigestDeliveryAcknowledgementEscalationSlaBreachReviewPreviewBlockedAction[];
  ...
  noWrite: GfisAssistantDks245DigestDeliveryAcknowledgementEscalationSlaBreachReviewPreviewNoWrite;
}
