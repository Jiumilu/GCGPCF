...
export type GfisAssistantDks239AcknowledgementEscalationPreviewType =
...
export type GfisAssistantDks239AcknowledgementEscalationPreviewStatus =
...
export type GfisAssistantDks239AcknowledgementEscalationPreviewDecision =
...
export type GfisAssistantDks239AcknowledgementEscalationPreviewScope =
  | "team_internal"
  | "project_internal"
  | "governance_review"
  | "external_blocked"
...
export type GfisAssistantDks239AcknowledgementEscalationPreviewLevel =
...
export type GfisAssistantDks239AcknowledgementEscalationPreviewTrigger =
...
export type GfisAssistantDks239AcknowledgementEscalationPreviewReason =
  | "acknowledgement_timeout_candidate"
...
export type GfisAssistantDks239AcknowledgementEscalationPreviewBlockedAction =
  | "create_escalation"
...
export interface GfisAssistantDks239AcknowledgementEscalationPreviewNoWrite {
  writesGfis: 0;
  writesGpc: 0;
  writesErp: 0;
  writesMes: 0;
...
export interface GfisAssistantDks239AcknowledgementEscalationPreview {
  ...
  escalationType: GfisAssistantDks239AcknowledgementEscalationPreviewType;
  escalationStatus: GfisAssistantDks239AcknowledgementEscalationPreviewStatus;
  escalationDecision: GfisAssistantDks239AcknowledgementEscalationPreviewDecision;
  escalationScope: GfisAssistantDks239AcknowledgementEscalationPreviewScope;
  escalationLevel: GfisAssistantDks239AcknowledgementEscalationPreviewLevel;
  escalationTrigger: GfisAssistantDks239AcknowledgementEscalationPreviewTrigger;
  candidateEscalationRecipientRefs: string[];
  requiredEvidenceRefs: string[];
  escalationReasonRefs: GfisAssistantDks239AcknowledgementEscalationPreviewReason[];
  ...
  blockedActions: GfisAssistantDks239AcknowledgementEscalationPreviewBlockedAction[];
  ...
  noWrite: GfisAssistantDks239AcknowledgementEscalationPreviewNoWrite;
}
