...
export type GfisAssistantDks240EscalationDigestPreviewType =
...
export type GfisAssistantDks240EscalationDigestPreviewStatus =
  | "digest_preview_only"
...
export type GfisAssistantDks240EscalationDigestPreviewDecision =
...
export type GfisAssistantDks240EscalationDigestPreviewScope =
  | "team_internal"
  | "project_internal"
  | "governance_review"
  | "external_blocked"
...
export type GfisAssistantDks240EscalationDigestPreviewChannel =
...
export type GfisAssistantDks240EscalationDigestPreviewPriority =
  | "normal_candidate"
  | "evidence_candidate"
  | "metadata_candidate"
  | "blocked_candidate"
...
export type GfisAssistantDks240EscalationDigestPreviewReason =
...
export type GfisAssistantDks240EscalationDigestPreviewBlockedAction =
  | "create_digest"
...
export interface GfisAssistantDks240EscalationDigestPreviewNoWrite {
  writesGfis: 0;
  writesGpc: 0;
  writesErp: 0;
  writesMes: 0;
...
export interface GfisAssistantDks240EscalationDigestPreview {
  ...
  digestType: GfisAssistantDks240EscalationDigestPreviewType;
  digestStatus: GfisAssistantDks240EscalationDigestPreviewStatus;
  digestDecision: GfisAssistantDks240EscalationDigestPreviewDecision;
  digestScope: GfisAssistantDks240EscalationDigestPreviewScope;
  digestChannel: GfisAssistantDks240EscalationDigestPreviewChannel;
  digestPriority: GfisAssistantDks240EscalationDigestPreviewPriority;
  candidateDigestRecipientRefs: string[];
  requiredEvidenceRefs: string[];
  digestReasonRefs: GfisAssistantDks240EscalationDigestPreviewReason[];
  ...
  blockedActions: GfisAssistantDks240EscalationDigestPreviewBlockedAction[];
  createsDigest: false;
  ...
  noWrite: GfisAssistantDks240EscalationDigestPreviewNoWrite;
}
