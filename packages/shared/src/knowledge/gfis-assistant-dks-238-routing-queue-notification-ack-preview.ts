...
export type GfisAssistantDks238RoutingQueueNotificationAckPreviewType =
...
export type GfisAssistantDks238RoutingQueueNotificationAckPreviewStatus =
...
export type GfisAssistantDks238RoutingQueueNotificationAckPreviewDecision =
...
export type GfisAssistantDks238RoutingQueueNotificationAckPreviewScope =
  | "team_internal"
  | "project_internal"
  | "governance_review"
  | "external_blocked"
...
export type GfisAssistantDks238RoutingQueueNotificationAckPreviewChannel =
...
export type GfisAssistantDks238RoutingQueueNotificationAckPreviewDeadline =
...
export type GfisAssistantDks238RoutingQueueNotificationAckPreviewReason =
...
export type GfisAssistantDks238RoutingQueueNotificationAckPreviewBlockedAction =
...
export interface GfisAssistantDks238RoutingQueueNotificationAckPreviewNoWrite {
  writesGfis: 0;
  writesGpc: 0;
  writesErp: 0;
  writesMes: 0;
...
export interface GfisAssistantDks238RoutingQueueNotificationAckPreview {
  ...
  acknowledgementType: GfisAssistantDks238RoutingQueueNotificationAckPreviewType;
  acknowledgementStatus: GfisAssistantDks238RoutingQueueNotificationAckPreviewStatus;
  acknowledgementDecision: GfisAssistantDks238RoutingQueueNotificationAckPreviewDecision;
  acknowledgementScope: GfisAssistantDks238RoutingQueueNotificationAckPreviewScope;
  acknowledgementChannel: GfisAssistantDks238RoutingQueueNotificationAckPreviewChannel;
  acknowledgementDeadline: GfisAssistantDks238RoutingQueueNotificationAckPreviewDeadline;
  candidateAcknowledgerRefs: string[];
  requiredEvidenceRefs: string[];
  acknowledgementReasonRefs: GfisAssistantDks238RoutingQueueNotificationAckPreviewReason[];
  ...
  blockedActions: GfisAssistantDks238RoutingQueueNotificationAckPreviewBlockedAction[];
  ...
  noWrite: GfisAssistantDks238RoutingQueueNotificationAckPreviewNoWrite;
}
