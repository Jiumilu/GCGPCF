...
export type GfisAssistantDks241DigestDeliveryPreviewType =
...
export type GfisAssistantDks241DigestDeliveryPreviewStatus =
...
export type GfisAssistantDks241DigestDeliveryPreviewDecision =
...
export type GfisAssistantDks241DigestDeliveryPreviewScope =
  | "team_internal"
  | "project_internal"
  | "governance_review"
  | "external_blocked"
...
export type GfisAssistantDks241DigestDeliveryPreviewChannel =
...
export type GfisAssistantDks241DigestDeliveryPreviewPriority =
...
export type GfisAssistantDks241DigestDeliveryPreviewReason =
  | "delivery_candidate"
...
export type GfisAssistantDks241DigestDeliveryPreviewBlockedAction =
...
export interface GfisAssistantDks241DigestDeliveryPreviewNoWrite {
  writesGfis: 0;
  writesGpc: 0;
  writesErp: 0;
  writesMes: 0;
...
export interface GfisAssistantDks241DigestDeliveryPreview {
  ...
  deliveryType: GfisAssistantDks241DigestDeliveryPreviewType;
  deliveryStatus: GfisAssistantDks241DigestDeliveryPreviewStatus;
  deliveryDecision: GfisAssistantDks241DigestDeliveryPreviewDecision;
  deliveryScope: GfisAssistantDks241DigestDeliveryPreviewScope;
  deliveryPriority: GfisAssistantDks241DigestDeliveryPreviewPriority;
  candidateRecipientRefs: string[];
  candidateChannelRefs: GfisAssistantDks241DigestDeliveryPreviewChannel[];
  deliveryReasonRefs: GfisAssistantDks241DigestDeliveryPreviewReason[];
  ...
  blockedActions: GfisAssistantDks241DigestDeliveryPreviewBlockedAction[];
  ...
  noWrite: GfisAssistantDks241DigestDeliveryPreviewNoWrite;
}
