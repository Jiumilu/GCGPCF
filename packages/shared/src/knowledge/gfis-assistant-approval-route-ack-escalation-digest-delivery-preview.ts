...
export type GfisAssistantApprovalRouteAckEscalationDigestDeliveryPreviewType =
...
export type GfisAssistantApprovalRouteAckEscalationDigestDeliveryPreviewStatus =
...
export type GfisAssistantApprovalRouteAckEscalationDigestDeliveryPreviewDecision =
...
export type GfisAssistantApprovalRouteAckEscalationDigestDeliveryPreviewScope =
  | "team_internal"
  | "project_internal"
  | "governance_review"
  | "external_blocked"
...
export type GfisAssistantApprovalRouteAckEscalationDigestDeliveryPreviewChannel =
...
export type GfisAssistantApprovalRouteAckEscalationDigestDeliveryPreviewBlockedAction =
...
export interface GfisAssistantApprovalRouteAckEscalationDigestDeliveryPreviewNoWrite {
  writesGfis: 0;
  writesGpc: 0;
  writesErp: 0;
  writesMes: 0;
...
export interface GfisAssistantApprovalRouteAckEscalationDigestDeliveryPreview {
  ...
  deliveryType: GfisAssistantApprovalRouteAckEscalationDigestDeliveryPreviewType;
  deliveryStatus: GfisAssistantApprovalRouteAckEscalationDigestDeliveryPreviewStatus;
  deliveryDecision: GfisAssistantApprovalRouteAckEscalationDigestDeliveryPreviewDecision;
  deliveryScope: GfisAssistantApprovalRouteAckEscalationDigestDeliveryPreviewScope;
  candidateRecipientRefs: string[];
  candidateChannelRefs: GfisAssistantApprovalRouteAckEscalationDigestDeliveryPreviewChannel[];
  ...
  blockedActions: GfisAssistantApprovalRouteAckEscalationDigestDeliveryPreviewBlockedAction[];
  ...
  noWrite: GfisAssistantApprovalRouteAckEscalationDigestDeliveryPreviewNoWrite;
}
