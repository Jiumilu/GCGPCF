...
export type GfisAssistantApprovalRouteAckEscalationDigestDeliveryAckEscalationSlaPreviewType =
...
export type GfisAssistantApprovalRouteAckEscalationDigestDeliveryAckEscalationSlaPreviewStatus =
  | "sla_preview_only"
  | "sla_at_risk_preview"
...
export type GfisAssistantApprovalRouteAckEscalationDigestDeliveryAckEscalationSlaPreviewDecision =
...
export type GfisAssistantApprovalRouteAckEscalationDigestDeliveryAckEscalationSlaPreviewScope =
  | "team_internal"
  | "project_internal"
  | "governance_review"
  | "external_blocked"
...
export type GfisAssistantApprovalRouteAckEscalationDigestDeliveryAckEscalationSlaPreviewRisk =
...
export type GfisAssistantApprovalRouteAckEscalationDigestDeliveryAckEscalationSlaPreviewReason =
...
export type GfisAssistantApprovalRouteAckEscalationDigestDeliveryAckEscalationSlaPreviewBlockedAction =
  | "create_sla_timer"
  | "create_escalation"
  | "create_reminder"
...
export interface GfisAssistantApprovalRouteAckEscalationDigestDeliveryAckEscalationSlaPreviewNoWrite {
  writesGfis: 0;
  writesGpc: 0;
  writesErp: 0;
  writesMes: 0;
...
export interface GfisAssistantApprovalRouteAckEscalationDigestDeliveryAckEscalationSlaPreview {
  slaPreviewId: string;
  ...
  slaType: GfisAssistantApprovalRouteAckEscalationDigestDeliveryAckEscalationSlaPreviewType;
  slaStatus: GfisAssistantApprovalRouteAckEscalationDigestDeliveryAckEscalationSlaPreviewStatus;
  slaDecision: GfisAssistantApprovalRouteAckEscalationDigestDeliveryAckEscalationSlaPreviewDecision;
  slaScope: GfisAssistantApprovalRouteAckEscalationDigestDeliveryAckEscalationSlaPreviewScope;
  slaWindowMinutes: number;
  elapsedMinutes: number;
  remainingMinutes: number;
  overdueMinutes: number;
  slaRisk: GfisAssistantApprovalRouteAckEscalationDigestDeliveryAckEscalationSlaPreviewRisk;
  candidateEscalationOwnerRefs: string[];
  slaReasonRefs: GfisAssistantApprovalRouteAckEscalationDigestDeliveryAckEscalationSlaPreviewReason[];
  ...
  blockedActions: GfisAssistantApprovalRouteAckEscalationDigestDeliveryAckEscalationSlaPreviewBlockedAction[];
  ...
  noWrite: GfisAssistantApprovalRouteAckEscalationDigestDeliveryAckEscalationSlaPreviewNoWrite;
}
