...
export type GfisAssistantDks246DigestDeliveryAcknowledgementEscalationSlaBreachReviewResolutionOptionPreviewType =
...
export type GfisAssistantDks246DigestDeliveryAcknowledgementEscalationSlaBreachReviewResolutionOptionPreviewStatus =
...
export type GfisAssistantDks246DigestDeliveryAcknowledgementEscalationSlaBreachReviewResolutionOptionPreviewDecision =
...
export type GfisAssistantDks246DigestDeliveryAcknowledgementEscalationSlaBreachReviewResolutionOptionPreviewScope =
  | "team_internal"
  | "project_internal"
  | "governance_review"
  | "external_blocked"
...
export type GfisAssistantDks246DigestDeliveryAcknowledgementEscalationSlaBreachReviewResolutionOptionPreviewPriority =
  | "p3_candidate"
  | "p2_candidate"
  | "p1_candidate"
...
export type GfisAssistantDks246DigestDeliveryAcknowledgementEscalationSlaBreachReviewResolutionOptionPreviewReason =
...
export type GfisAssistantDks246DigestDeliveryAcknowledgementEscalationSlaBreachReviewResolutionOptionPreviewBlockedAction =
  | "create_resolution"
...
export interface GfisAssistantDks246DigestDeliveryAcknowledgementEscalationSlaBreachReviewResolutionOptionPreviewNoWrite {
  writesGfis: 0;
  writesGpc: 0;
  writesErp: 0;
  writesMes: 0;
...
export interface GfisAssistantDks246DigestDeliveryAcknowledgementEscalationSlaBreachReviewResolutionOptionPreview {
  ...
  resolutionOptionType: GfisAssistantDks246DigestDeliveryAcknowledgementEscalationSlaBreachReviewResolutionOptionPreviewType;
  resolutionOptionStatus: GfisAssistantDks246DigestDeliveryAcknowledgementEscalationSlaBreachReviewResolutionOptionPreviewStatus;
  resolutionOptionDecision: GfisAssistantDks246DigestDeliveryAcknowledgementEscalationSlaBreachReviewResolutionOptionPreviewDecision;
  resolutionOptionScope: GfisAssistantDks246DigestDeliveryAcknowledgementEscalationSlaBreachReviewResolutionOptionPreviewScope;
  resolutionPriority: GfisAssistantDks246DigestDeliveryAcknowledgementEscalationSlaBreachReviewResolutionOptionPreviewPriority;
  candidateAssigneeRefs: string[];
  requiredEvidenceRefs: string[];
  resolutionReasonRefs: GfisAssistantDks246DigestDeliveryAcknowledgementEscalationSlaBreachReviewResolutionOptionPreviewReason[];
  ...
  blockedActions: GfisAssistantDks246DigestDeliveryAcknowledgementEscalationSlaBreachReviewResolutionOptionPreviewBlockedAction[];
  ...
  noWrite: GfisAssistantDks246DigestDeliveryAcknowledgementEscalationSlaBreachReviewResolutionOptionPreviewNoWrite;
}
