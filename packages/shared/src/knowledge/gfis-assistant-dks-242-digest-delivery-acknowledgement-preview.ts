...
export type GfisAssistantDks242DigestDeliveryAcknowledgementPreviewType =
...
export type GfisAssistantDks242DigestDeliveryAcknowledgementPreviewStatus =
...
export type GfisAssistantDks242DigestDeliveryAcknowledgementPreviewDecision =
...
export type GfisAssistantDks242DigestDeliveryAcknowledgementPreviewScope =
  | "team_internal"
  | "project_internal"
  | "governance_review"
  | "external_blocked"
...
export type GfisAssistantDks242DigestDeliveryAcknowledgementPreviewMethod =
...
export type GfisAssistantDks242DigestDeliveryAcknowledgementPreviewPriority =
...
export type GfisAssistantDks242DigestDeliveryAcknowledgementPreviewReason =
...
export type GfisAssistantDks242DigestDeliveryAcknowledgementPreviewBlockedAction =
...
export interface GfisAssistantDks242DigestDeliveryAcknowledgementPreviewNoWrite {
  writesGfis: 0;
  writesGpc: 0;
  writesErp: 0;
  writesMes: 0;
...
export interface GfisAssistantDks242DigestDeliveryAcknowledgementPreview {
  ...
  acknowledgementType: GfisAssistantDks242DigestDeliveryAcknowledgementPreviewType;
  acknowledgementStatus: GfisAssistantDks242DigestDeliveryAcknowledgementPreviewStatus;
  acknowledgementDecision: GfisAssistantDks242DigestDeliveryAcknowledgementPreviewDecision;
  acknowledgementScope: GfisAssistantDks242DigestDeliveryAcknowledgementPreviewScope;
  acknowledgementPriority: GfisAssistantDks242DigestDeliveryAcknowledgementPreviewPriority;
  candidateAcknowledgerRefs: string[];
  acknowledgementMethodRefs: GfisAssistantDks242DigestDeliveryAcknowledgementPreviewMethod[];
  acknowledgementReasonRefs: GfisAssistantDks242DigestDeliveryAcknowledgementPreviewReason[];
  ...
  blockedActions: GfisAssistantDks242DigestDeliveryAcknowledgementPreviewBlockedAction[];
  ...
  noWrite: GfisAssistantDks242DigestDeliveryAcknowledgementPreviewNoWrite;
}
