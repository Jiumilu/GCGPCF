...
export type GfisAssistantDks194RoutingQueueNotificationAcknowledgementEscalationDigestDeliveryAckPreviewType =
...
export type GfisAssistantDks194RoutingQueueNotificationAcknowledgementEscalationDigestDeliveryAckPreviewStatus =
...
export type GfisAssistantDks194RoutingQueueNotificationAcknowledgementEscalationDigestDeliveryAckPreviewDecision =
...
export type GfisAssistantDks194RoutingQueueNotificationAcknowledgementEscalationDigestDeliveryAckPreviewScope =
  | "team_internal"
  | "project_internal"
  | "governance_review"
  | "external_blocked"
...
export type GfisAssistantDks194RoutingQueueNotificationAcknowledgementEscalationDigestDeliveryAckPreviewMethod =
...
export type GfisAssistantDks194RoutingQueueNotificationAcknowledgementEscalationDigestDeliveryAckPreviewBlockedAction =
...
export interface GfisAssistantDks194RoutingQueueNotificationAcknowledgementEscalationDigestDeliveryAckPreviewNoWrite {
  writesGfis: 0;
  writesGpc: 0;
  writesErp: 0;
  writesMes: 0;
...
export interface GfisAssistantDks194RoutingQueueNotificationAcknowledgementEscalationDigestDeliveryAckPreview {
  ...
  acknowledgementType: GfisAssistantDks194RoutingQueueNotificationAcknowledgementEscalationDigestDeliveryAckPreviewType;
  acknowledgementStatus: GfisAssistantDks194RoutingQueueNotificationAcknowledgementEscalationDigestDeliveryAckPreviewStatus;
  acknowledgementDecision: GfisAssistantDks194RoutingQueueNotificationAcknowledgementEscalationDigestDeliveryAckPreviewDecision;
  acknowledgementScope: GfisAssistantDks194RoutingQueueNotificationAcknowledgementEscalationDigestDeliveryAckPreviewScope;
  candidateAcknowledgerRefs: string[];
  acknowledgementMethodRefs: GfisAssistantDks194RoutingQueueNotificationAcknowledgementEscalationDigestDeliveryAckPreviewMethod[];
  ...
  blockedActions: GfisAssistantDks194RoutingQueueNotificationAcknowledgementEscalationDigestDeliveryAckPreviewBlockedAction[];
  ...
  noWrite: GfisAssistantDks194RoutingQueueNotificationAcknowledgementEscalationDigestDeliveryAckPreviewNoWrite;
}
