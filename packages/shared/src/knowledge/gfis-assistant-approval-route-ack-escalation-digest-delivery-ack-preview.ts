...
export type GfisAssistantApprovalRouteAckEscalationDigestDeliveryAckPreviewType =
...
export type GfisAssistantApprovalRouteAckEscalationDigestDeliveryAckPreviewStatus =
...
export type GfisAssistantApprovalRouteAckEscalationDigestDeliveryAckPreviewDecision =
...
export type GfisAssistantApprovalRouteAckEscalationDigestDeliveryAckPreviewScope =
  | "team_internal"
  | "project_internal"
  | "governance_review"
  | "external_blocked"
...
export type GfisAssistantApprovalRouteAckEscalationDigestDeliveryAckPreviewMethod =
...
export type GfisAssistantApprovalRouteAckEscalationDigestDeliveryAckPreviewBlockedAction =
...
export interface GfisAssistantApprovalRouteAckEscalationDigestDeliveryAckPreviewNoWrite {
  writesGfis: 0;
  writesGpc: 0;
  writesErp: 0;
  writesMes: 0;
...
export interface GfisAssistantApprovalRouteAckEscalationDigestDeliveryAckPreview {
  ...
  acknowledgementType: GfisAssistantApprovalRouteAckEscalationDigestDeliveryAckPreviewType;
  acknowledgementStatus: GfisAssistantApprovalRouteAckEscalationDigestDeliveryAckPreviewStatus;
  acknowledgementDecision: GfisAssistantApprovalRouteAckEscalationDigestDeliveryAckPreviewDecision;
  acknowledgementScope: GfisAssistantApprovalRouteAckEscalationDigestDeliveryAckPreviewScope;
  candidateAcknowledgerRefs: string[];
  acknowledgementMethodRefs: GfisAssistantApprovalRouteAckEscalationDigestDeliveryAckPreviewMethod[];
  ...
  blockedActions: GfisAssistantApprovalRouteAckEscalationDigestDeliveryAckPreviewBlockedAction[];
  ...
  noWrite: GfisAssistantApprovalRouteAckEscalationDigestDeliveryAckPreviewNoWrite;
}
