...
export type GfisAssistantDks236RoutingQueuePreviewType =
...
export type GfisAssistantDks236RoutingQueuePreviewStatus =
...
export type GfisAssistantDks236RoutingQueuePreviewDecision =
...
export type GfisAssistantDks236RoutingQueuePreviewScope =
  | "team_internal"
  | "project_internal"
  | "governance_review"
  | "external_blocked"
...
export type GfisAssistantDks236RoutingQueuePreviewSlot =
...
export type GfisAssistantDks236RoutingQueuePreviewPriority =
  | "normal_candidate"
  | "evidence_candidate"
  | "metadata_candidate"
  | "blocked_candidate"
...
export type GfisAssistantDks236RoutingQueuePreviewReason =
...
export type GfisAssistantDks236RoutingQueuePreviewBlockedAction =
...
export interface GfisAssistantDks236RoutingQueuePreviewNoWrite {
  writesGfis: 0;
  writesGpc: 0;
  writesErp: 0;
  writesMes: 0;
...
export interface GfisAssistantDks236RoutingQueuePreview {
  ...
  routingQueueType: GfisAssistantDks236RoutingQueuePreviewType;
  routingQueueStatus: GfisAssistantDks236RoutingQueuePreviewStatus;
  routingQueueDecision: GfisAssistantDks236RoutingQueuePreviewDecision;
  routingQueueScope: GfisAssistantDks236RoutingQueuePreviewScope;
  routingQueueSlot: GfisAssistantDks236RoutingQueuePreviewSlot;
  routingQueuePriority: GfisAssistantDks236RoutingQueuePreviewPriority;
  candidateAssigneeRefs: string[];
  requiredEvidenceRefs: string[];
  queueReasonRefs: GfisAssistantDks236RoutingQueuePreviewReason[];
  ...
  blockedActions: GfisAssistantDks236RoutingQueuePreviewBlockedAction[];
  ...
  noWrite: GfisAssistantDks236RoutingQueuePreviewNoWrite;
}
