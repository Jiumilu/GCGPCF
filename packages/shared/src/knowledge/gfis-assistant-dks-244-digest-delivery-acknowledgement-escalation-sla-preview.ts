...
export type GfisAssistantDks244DigestDeliveryAcknowledgementEscalationSlaPreviewType =
...
export type GfisAssistantDks244DigestDeliveryAcknowledgementEscalationSlaPreviewStatus =
  | "sla_preview_only"
  | "sla_at_risk_preview"
...
export type GfisAssistantDks244DigestDeliveryAcknowledgementEscalationSlaPreviewDecision =
...
export type GfisAssistantDks244DigestDeliveryAcknowledgementEscalationSlaPreviewScope =
  | "team_internal"
  | "project_internal"
  | "governance_review"
  | "external_blocked"
...
export type GfisAssistantDks244DigestDeliveryAcknowledgementEscalationSlaPreviewRisk =
...
export type GfisAssistantDks244DigestDeliveryAcknowledgementEscalationSlaPreviewReason =
...
export type GfisAssistantDks244DigestDeliveryAcknowledgementEscalationSlaPreviewBlockedAction =
  | "create_sla_timer"
  | "create_escalation"
  | "create_reminder"
...
export interface GfisAssistantDks244DigestDeliveryAcknowledgementEscalationSlaPreviewNoWrite {
  writesGfis: 0;
  writesGpc: 0;
  writesErp: 0;
  writesMes: 0;
...
export interface GfisAssistantDks244DigestDeliveryAcknowledgementEscalationSlaPreview {
  slaPreviewId: string;
  ...
  slaType: GfisAssistantDks244DigestDeliveryAcknowledgementEscalationSlaPreviewType;
  slaStatus: GfisAssistantDks244DigestDeliveryAcknowledgementEscalationSlaPreviewStatus;
  slaDecision: GfisAssistantDks244DigestDeliveryAcknowledgementEscalationSlaPreviewDecision;
  slaScope: GfisAssistantDks244DigestDeliveryAcknowledgementEscalationSlaPreviewScope;
  slaWindowMinutes: number;
  elapsedMinutes: number;
  remainingMinutes: number;
  overdueMinutes: number;
  slaRisk: GfisAssistantDks244DigestDeliveryAcknowledgementEscalationSlaPreviewRisk;
  candidateEscalationOwnerRefs: string[];
  slaReasonRefs: GfisAssistantDks244DigestDeliveryAcknowledgementEscalationSlaPreviewReason[];
  ...
  blockedActions: GfisAssistantDks244DigestDeliveryAcknowledgementEscalationSlaPreviewBlockedAction[];
  ...
  noWrite: GfisAssistantDks244DigestDeliveryAcknowledgementEscalationSlaPreviewNoWrite;
}
