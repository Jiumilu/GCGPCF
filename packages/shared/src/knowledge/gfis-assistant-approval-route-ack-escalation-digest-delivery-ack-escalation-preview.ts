...
export type GfisAssistantApprovalRouteAckEscalationDigestDeliveryAckEscalationPreviewType =
...
export type GfisAssistantApprovalRouteAckEscalationDigestDeliveryAckEscalationPreviewStatus =
...
export type GfisAssistantApprovalRouteAckEscalationDigestDeliveryAckEscalationPreviewDecision =
...
export type GfisAssistantApprovalRouteAckEscalationDigestDeliveryAckEscalationPreviewScope =
  | "team_internal"
  | "project_internal"
  | "governance_review"
  | "external_blocked"
...
export type GfisAssistantApprovalRouteAckEscalationDigestDeliveryAckEscalationPreviewReason =
...
export type GfisAssistantApprovalRouteAckEscalationDigestDeliveryAckEscalationPreviewBlockedAction =
  | "create_escalation"
...
export interface GfisAssistantApprovalRouteAckEscalationDigestDeliveryAckEscalationPreviewNoWrite {
  writesGfis: 0;
  writesGpc: 0;
  writesErp: 0;
  writesMes: 0;
...
export interface GfisAssistantApprovalRouteAckEscalationDigestDeliveryAckEscalationPreview {
  ...
  escalationType: GfisAssistantApprovalRouteAckEscalationDigestDeliveryAckEscalationPreviewType;
  escalationStatus: GfisAssistantApprovalRouteAckEscalationDigestDeliveryAckEscalationPreviewStatus;
  escalationDecision: GfisAssistantApprovalRouteAckEscalationDigestDeliveryAckEscalationPreviewDecision;
  escalationScope: GfisAssistantApprovalRouteAckEscalationDigestDeliveryAckEscalationPreviewScope;
  candidateEscalationOwnerRefs: string[];
  escalationReasonRefs: GfisAssistantApprovalRouteAckEscalationDigestDeliveryAckEscalationPreviewReason[];
  ...
  blockedActions: GfisAssistantApprovalRouteAckEscalationDigestDeliveryAckEscalationPreviewBlockedAction[];
  ...
  noWrite: GfisAssistantApprovalRouteAckEscalationDigestDeliveryAckEscalationPreviewNoWrite;
}
