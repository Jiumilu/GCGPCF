...
export type GfisAssistantDks258AckEscalationSlaBreachReviewResolutionOptionPreviewType =
...
export type GfisAssistantDks258AckEscalationSlaBreachReviewResolutionOptionPreviewStatus =
...
export type GfisAssistantDks258AckEscalationSlaBreachReviewResolutionOptionPreviewDecision =
...
export type GfisAssistantDks258AckEscalationSlaBreachReviewResolutionOptionPreviewScope =
  | "team_internal"
  | "project_internal"
  | "governance_review"
  | "external_blocked"
...
export type GfisAssistantDks258AckEscalationSlaBreachReviewResolutionOptionPreviewPriority =
  | "p3_candidate"
  | "p2_candidate"
  | "p1_candidate"
...
export type GfisAssistantDks258AckEscalationSlaBreachReviewResolutionOptionPreviewReason =
...
export type GfisAssistantDks258AckEscalationSlaBreachReviewResolutionOptionPreviewBlockedAction =
  | "create_resolution"
...
export interface GfisAssistantDks258AckEscalationSlaBreachReviewResolutionOptionPreviewNoWrite {
  writesGfis: 0;
  writesGpc: 0;
  writesErp: 0;
  writesMes: 0;
...
export interface GfisAssistantDks258AckEscalationSlaBreachReviewResolutionOptionPreview {
  ...
  resolutionOptionType: GfisAssistantDks258AckEscalationSlaBreachReviewResolutionOptionPreviewType;
  resolutionOptionStatus: GfisAssistantDks258AckEscalationSlaBreachReviewResolutionOptionPreviewStatus;
  resolutionOptionDecision: GfisAssistantDks258AckEscalationSlaBreachReviewResolutionOptionPreviewDecision;
  resolutionOptionScope: GfisAssistantDks258AckEscalationSlaBreachReviewResolutionOptionPreviewScope;
  resolutionPriority: GfisAssistantDks258AckEscalationSlaBreachReviewResolutionOptionPreviewPriority;
  candidateAssigneeRefs: string[];
  requiredEvidenceRefs: string[];
  resolutionReasonRefs: GfisAssistantDks258AckEscalationSlaBreachReviewResolutionOptionPreviewReason[];
  ...
  blockedActions: GfisAssistantDks258AckEscalationSlaBreachReviewResolutionOptionPreviewBlockedAction[];
  ...
  noWrite: GfisAssistantDks258AckEscalationSlaBreachReviewResolutionOptionPreviewNoWrite;
}
